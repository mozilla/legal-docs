...
Az Egyesült Államokban a Firefox a Mozilla kiszolgálóiról kér le javaslatokat, miközben megadja a lekérdezését. Egy [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/) nevű adatvédelmi technológiát használunk, amely titkosítást és egy proxykiszolgálót kombinál az IP-címe és más azonosító információi elrejtésére. A valós idejű keresési lekérdezése, valamint a technikai, interakciós és IP-címből származó helyadatok alapértelmezés szerint ezen az OHTTP-proxyn keresztül kerülnek továbbításra, mielőtt a Mozillának küldenék. Ez segít megakadályozni, hogy bárki (beleértve a Mozillát is) az Ön konkrét lekérdezését Önhöz társítsa, vagy azt a böngészési tevékenységével kapcsolatos, ehhez nem kapcsolódó információkkal kombinálja. A Mozilla ezeket az adatokat azért kezeli, hogy releváns javaslatokat jelenítsen meg Önnek, megértse, mennyire hasznosak a javaslatok az Ön számára, és fejlessze a szolgáltatást. Bizonyos körülmények között a Mozilla partnerei anonimizált keresési és interakciós adatokat kapnak, hogy releváns javaslatokat jeleníthessenek meg, és mérhessék a felhasználók elköteleződését a javasolt tartalommal kapcsolatban.

Néhány felhasználó – beleértve az Egyesült Államokon kívüli régiókban élő felhasználókat és az Egyesült Államokban élő felhasználókat, akik kikapcsolják a „Javaslatok lekérése a Mozillától gépelés közben” beállítást a beállításaikban – ehelyett helyben feldolgozott eredményeket kapnak a Firefox Javaslatok funkciójának használatakor. E felhasználók számára a javaslatok helyben, az eszközükön, a Firefox-példányukban tárolt információk felhasználásával jelennek meg. Az adott lekérdezési kulcsszavakra (de nem a keresési lekérdezésre) vonatkozó, anonimizált kattintási és interakciós adatait OHTTP-n keresztül küldjük el a Mozillának, hogy elrejtsük az IP-címét és egyéb azonosító adatait. Szponzorált javaslatok esetén a partnereink összesített információkat kaphatnak arról, hogy mely javaslataik jelennek meg és melyekre kattintanak rá, de azt nem, hogy mely felhasználók látták a javaslatokat, vagy mely kulcsszavak okozták a javaslatok megjelenítését. (Ha a Firefox javaslatai nem érhetők el az Ön régiójában, akkor csak keresési javaslatokat fog kapni).

### Releváns tartalom és hirdetések megjelenítése a Firefox Új lapján

A Firefox az Új lapon jeleníti meg a tartalmat, valamint a fejlesztését támogató hirdetéseket. Ezeket bármikor kikapcsolhatja a böngésző beállításaiban.

Technikai adatokat, nyelvi beállításokat és IP-címből származó helyadatokat használunk fel ahhoz, hogy ezt a tartalmat a megfelelő formátumban (azaz mobil és asztali számítógéphez), nyelven és releváns helyen jelenítsük meg. A Mozilla technikai és interakciós adatokat gyűjt, például pozíciót, méretet, megtekintést és az Új lapon található tartalmakra vagy hirdetések kattintásait, hogy megértse, hogyan lépnek kapcsolatba a felhasználók a tartalommal, és személyre szabhatja a jövőbeli tartalmakat, beleértve a szponzorált tartalmakat is. Ezeket az adatokat összesített és/vagy anonimizált formában oszthatjuk meg a hirdetési partnereinkkel.

Bizonyos régiókban ezeket az adatokat modellek felépítésére és a felhasználók közös attribútumok szerinti csoportosítására használjuk. Ezek a csoportosítások segítenek megérteni, hogy az emberek hogyan lépnek interakcióba a tartalmainkkal, és segítenek személyre szabni a jövőbeli tartalmakat, beleértve a szponzorált tartalmakat is. Eszközön belüli kezelést és OHTTP-t használunk annak érdekében, hogy elkerüljük bármely adott felhasználó attribútumainak felfedését a Mozilla számára. [További információk](https://support.mozilla.org/kb/firefox-new-tab-personalization).

Emellett hirdetési szolgáltatókkal is együttműködünk, hogy programozott technológiák segítségével releváns szponzorált tartalmakat biztosítsunk. Ennek támogatása érdekében megoszthatunk korlátozott, nem azonosítható információkat – például az eszköztípust, az IP-címből származó helyadatokat és a megtekintett tartalom kategóriáját –, hogy segítsünk meghatározni, mely hirdetéseket jelenítsük meg. Nem osztunk meg semmilyen olyan információt, amely azonosítaná Önt. A szponzorált tartalmakat bármikor kikapcsolhatja az Új lap beállításaiban.

Bizonyos esetekben, amikor a hirdetések engedélyezve vannak az Új lapon, további böngészési és interakciós adatokat (beleértve a hirdetőinkkel folytatott interakciókat is) kezelhetünk helyben az eszközén a hirdetések hatékonyságának mérése érdekében. A [gyorsbillentyűk](https://support.mozilla.org/kb/about-new-tab-page#w_shortcuts) funkció az eszközön tárolt helyi böngészési adatokat is felhasználja a legjobb gyorsbillentyűk kiválasztásához, amelyek közül néhány szponzorált is lehet. Az ilyen jellegű adatokat kizárólag összesített és/vagy anonimizált alapon osztjuk meg a Mozillával és/vagy hirdetési partnereinkkel az adatvédelmi technológiáinkon keresztül.
...
A böngésző beállításaiban ([asztali](https://support.mozilla.org/kb/customize-your-new-tab-page), [Android](https://support.mozilla.org/kb/customize-firefox-home-screen), [iOS](https://support.mozilla.org/kb/customize-firefox-home-ios)) kikapcsolhatja vagy testreszabhatja ezeket az Új lap funkcióit, valamint a hozzájuk tartozó adatkezelést. A [szponzorált tartalmakat letilthatja](https://support.mozilla.org/kb/sponsor-privacy), miközben folytatja a többi funkciót használatát.
...
*További részletek, beleértve az adatbeállítások módosítását:* Bármikor frissítheti az adatgyűjtési beállításait az [asztali számítógépen](https://support.mozilla.org/kb/share-data-mozilla-help-improve-firefox) és a [mobileszközön](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy). Tartsa szem előtt, hogy a „Firefox technikai és interakciós adatok küldésének engedélyezése a Mozillának” jelölőnégyzet bejelölésének törlése nem befolyásolja a [Napi használati pinget](https://support.mozilla.org/kb/usage-ping-settings). Ez a Napi használati ping kizárólag nem beazonosítható adatokkal szolgál számunkra arról, hogy a felhasználó Firefoxot használ, és nem kapcsolódik semmilyen más Önre vonatkozó adathoz, és a beállításokban letiltható.
...
## Alkalmazhatóság (Firefox-verzió)
...
| Adattípus | Leírás | Példák Firefox-felhasználók számára |
| ----- | ----- | ----- |
...
| Egyedi azonosítók | Ezek egyedi azonosítók, amelyek különböző időpontokban hozhatók létre a szolgáltatással való interakciók kezelésére. | Client_id, session_id, cookie-azonosítók. |
...
| Interakciós adatok | Adatok arról, hogy Ön hogyan használja a szolgáltatásainkat, például hány lap van nyitva, vagy mire kattintott. | Kattintások száma, megjelenítési adatok, hozzárendelési adatok, a végrehajtott keresések száma, az oldalon töltött idő, a hirdetésekre és a szponzorált csempére leadott kattintások. |
| Böngészési adatok | Az Ön által meglátogatott webhelyekre és URL-címekre vonatkozó információk. Ez magában foglalhatja a böngészési adatok kategóriáit (utazás, vásárlás, közösségi média), legfelső szintű tartományok (example.com) vagy konkrét meglátogatott weboldalakat. | Böngészési kategória, legfelső szintű tartományok (TLD), adott URL-címek. |
| Keresési adatok | Ezek a keresési kategóriákra, a keresési kulcsszavakra vagy a keresett kifejezések keresési lekérdezésére vonatkozó adatok. | Keresési kategória (élelmiszer, utazás), kulcsszavak („Boston”), keresési kifejezés („időjárás Bostonban”). |
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>További információkat is megtudhat a <a href="https://support.mozilla.org/kb/website-translation">fordításról</a> és az <a href="https://support.mozilla.org/kb/pdf-alt-text">alternatív szövegek hozzáadásáról a PDF-fájlokban lévő képekhez </a>.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>További információkat olvashat az <a href="https://support.mozilla.org/kb/customize-your-new-tab-page">Új lap oldal kezeléséről</a>, beleértve az <a href="https://support.mozilla.org/kb/sponsor-privacy">adatbeállításokat</a> is. A személyre szabás és/vagy a szponzorált tartalom kikapcsolásával bármikor letilthatja adatainak személyre szabási vagy hirdetési célú kezelését.</td>
        </tr>
        <tr>
