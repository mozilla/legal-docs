...
Il se peut que vous puissiez opter pour une expérience de recherche améliorée, ce qui amènera Mozilla à traiter des données personnelles supplémentaires, y compris vos données techniques, votre localisation et vos données de recherche. Certaines de ces informations peuvent être partagées avec nos partenaires sur une base dépersonnalisée et/ou agrégée. Voir notre [article de blog](https://blog.mozilla.org/data/2021/09/15/data-and-firefox-suggest/) « Données et Firefox Suggest » pour plus de détails.
...
Vous pouvez consulter plus d'informations sur [la gestion de votre page Nouvel onglet](https://support.mozilla.org/kb/customize-your-new-tab-page), notamment vos [paramètres de données](https://support.mozilla.org/kb/sponsor-privacy). Vous pouvez refuser que vos données soient traitées à des fins de personnalisation ou de publicité en désactivant à tout moment les « données techniques et d'interaction » sur les versions [Ordinateur](https://support.mozilla.org/kb/share-data-mozilla-help-improve-firefox) et [Mobile](https://support.mozilla.org/kb/send-usage-data-firefox-mobile-browsers).
...
Vous pouvez lire plus d'informations sur [Comment utiliser le Vérificateur d'avis Firefox](https://support.mozilla.org/kb/review-checker-review-quality) et comment nous mettons en œuvre des technologies de protection de la vie privée telles que OHTTP.
...
[Comment supprimer ou activer des extensions](https://support.mozilla.org/kb/disable-or-remove-add-ons). Vous pouvez aussi consulter la [Politique de confidentialité](https://www.mozilla.org/privacy/websites/) du [site web des extensions](https://addons.mozilla.org/firefox/).
...
[Mises à niveau et liste d'extensions](https://support.mozilla.org/kb/how-stop-firefox-making-automatic-connections), [Service Navigation sécurisée de Google](https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work), [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/)
...
## Comment vos données sont-elles partagées ?
...
Vous pouvez modifier vos paramètres de collecte de données pour les versions [Ordinateur](https://support.mozilla.org/kb/share-data-mozilla-help-improve-firefox) et [Mobile](https://support.mozilla.org/kb/send-usage-data-firefox-mobile-browsers) à tout moment.
...
## Domaine d'application (version Firefox) et modifications
...
| Identifiants uniques | Il s'agit d'identifiants uniques, qui peuvent être créés à différents moments pour gérer vos interactions avec le service.  | Client_id, session_id, cookie identifiers.  |
| Données sur les performances du système | Il s'agit de données sur le fonctionnement des services sur votre appareil.  | Utilisation de la mémoire, vitesse d'affichage des pages. |
...
| Données de recherche | Il s'agit des données relatives à la catégorie de recherche, aux mots-clés de recherche ou à la requête des termes recherchés.  | Catégorie de recherche (Alimentation, Voyages), mots-clés (« Bordeaux »), terme de recherche (« météo actuelle à Bordeaux »).  |
| Contenu | Lorsque vous nous le fournissez, nous pouvons traiter des données telles que des images téléchargées ou des réponses à des enquêtes. | Image téléchargée, signets, commentaires, réponses à une enquête.  |
| Données de contact | Lorsque vous nous les fournissez, nous pouvons traiter des données sur la manière de vous contacter.  | Adresse e-mail, numéro de téléphone. |
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Vous pouvez lire plus d'informations sur <a href="https://support.mozilla.org/kb/review-checker-review-quality">Comment utiliser le Vérificateur d'avis Firefox</a> et comment nous mettons en œuvre des technologies de protection de la vie privée telles que OHTTP.</td>
        </tr>
        <tr>
            ...
            <td>
                <p><a href="https://support.mozilla.org/kb/disable-or-remove-add-ons">Comment supprimer ou activer des extensions</a>.</p>
        ...
        <tr>
            ...
            <td>En savoir plus sur les <a href="https://support.mozilla.org/kb/how-stop-firefox-making-automatic-connections">Mises à niveau et la liste des extensions</a>, le <a href="https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work">Service de navigation sécurisée de Google</a>, <a href="https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/">OHTTP</a></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>En savoir plus sur les <a href="https://support.mozilla.org/kb/desktop-attribution-privacy">données de mesure de campagnes</a> collectées et partagées, et sur la manière de les refuser. Remarque - Firefox ne partage pas d'informations telles que votre historique de navigation, vos requêtes de recherche ou vos mots de passe enregistrés avec des partenaires technologiques de marketing. Mozilla ne recueille que les données nécessaires pour mesurer et améliorer ses campagnes de marketing.</td>
        </tr>
        <tr>
            <td>Pour pseudonymiser, dépersonnaliser, agréger ou anonymiser des données.</td>
            <td>
                <ul>
        ...
        <tr>
            <td>Respecter les lois en vigueur, identifier et prévenir les activités nuisibles, non autorisées ou illégales.</td>
            <td>
                <ul>
                    <li>Tous les types de données</li>
                </ul>
            </td>
            <td><strong>Respect de la loi</strong> en répondant aux demandes de droits des personnes concernées, en répondant aux demandes d'application de la loi, en gérant et en protégeant nos droits, notre propriété et/ou notre sécurité (ainsi que ceux de nos utilisateurs). <strong>Intérêt légitime</strong>, lorsque la conformité n'est pas appropriée, pour soutenir les processus ou demandes juridiques ou réglementaires, prévenir la fraude et gérer et protéger nos droits, nos biens et/ou notre sécurité (ainsi que ceux de nos utilisateurs).</td>
