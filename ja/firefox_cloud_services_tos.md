...
2. #### Mozilla アカウント
    ...
    本サービスの一部をご利用されるにあたり、皆様は Mozilla アカウントを作成する必要があります。登録の際、皆様はパスワードの設定を求められます。パスワードを秘密に保管すること、および Mozilla アカウントを通じて発生するアクティビティについては、皆様の責任となります。Mozilla は、皆様の Mozilla アカウントに対する未承認の使用に起因して発生するいかなる損失にも責任を負いません。
