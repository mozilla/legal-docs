...
* パーソナライズド広告:一部の Pocket ウェブページには広告があります。皆様が同意された場合に限り、Pocket 広告パートナーは広告 Cookie を皆様のデバイスに配置して、Pocket ウェブページや他のウェブサイトで表示される広告をパーソナライズします。Pocket で YouTube 動画を再生する場合、YouTube は パーソナライズ用の Cookie をデバイスに配置する場合があります。Mozilla のシンジケートされた記事のページに表示されるパーソナライズド広告のパートナー「PubMatic」には、独自の [プライバシーポリシー](https://pubmatic.com/legal/privacy-policy/) があります。
