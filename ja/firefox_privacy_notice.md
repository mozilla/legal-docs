...
Firefox は、おすすめ拡張機能、トップサイト（初めて Firefox を利用するユーザ向けの Mozilla によるおすすめウェブサイト）、おすすめなどのコンテンツを表示します。
