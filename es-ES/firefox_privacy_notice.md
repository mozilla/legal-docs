...
Vigente desde el lunes, 4 de mayo de 2026
{: datetime="2026-05-04" }
...
Si usted habilita la función Shake to Summarize en un dispositivo compatible que ejecuta un sistema operativo compatible que habilita la inteligencia en el dispositivo, los resúmenes que usted solicita serán creados localmente en su dispositivo. De lo contrario, cuando usted solicite un resumen, el contenido de su página se enviará a un servidor de Mozilla para ser procesado y se devolverá a su dispositivo; Mozilla no almacena este contenido ni los resúmenes resultantes. Obtenga más información sobre Shake to Summarize en [iOS](https://blog.mozilla.org/en/firefox/shake-to-summarize/) y [Android](https://support.mozilla.org/kb/summarize-pages-android).

*Más detalles, incluyendo cómo ajustar la configuración de sus datos:* Los datos procesados en su dispositivo permanecen bajo su control. Usted puede [administrar sus datos de navegación](https://support.mozilla.org/kb/delete-browsing-search-download-history-firefox) y su [configuración de almacenamiento local](https://support.mozilla.org/kb/storage), o actualizar los [permisos de ubicación](https://support.mozilla.org/kb/does-firefox-share-my-location-websites) en cualquier momento.

### Para proporcionarle el VPN de Firefox

Si usted ha iniciado sesión en una cuenta de Mozilla, puede activar una función de Firefox para ocultar su dirección IP a través de un servidor proxy ("VPN"). Cuando está activado, transmite el tráfico de red de Firefox a través de un intermediario para impedir que su proveedor de red vea los servidores a los que usted se conecta y ocultar su dirección IP de los sitios que visita. No transmite tráfico de proxy desde otras aplicaciones en el dispositivo, y no hace, por sí solo, que la navegación por su sitio web sea completamente anónima. El uso del VPN puede impactar su experiencia de navegación, incluso al servir contenido no específico para su región.

Utilizamos un servidor proxy operado en nuestro nombre para proporcionar la función VPN. El servidor proxy no tiene acceso al contenido de la página web u otra información sensible, como mensajes o contraseñas, y no recopila datos sobre los sitios web que usted visita ni el contenido de esos sitios. Procesamos datos técnicos limitados (como la versión del cliente, el estado de la conexión y el tipo de dispositivo/sistema operativo) para proporcionar, mantener y asegurar el rendimiento y la estabilidad del servicio, así como datos de interacción para entender el uso de la función y ayudar a guiar las mejoras.

### Para brindar y mejorar las funciones de búsqueda y las sugerencias
...
En los Estados Unidos, Firefox obtiene sugerencias de los servidores de Mozilla mientras usted escribe su consulta. Usamos una tecnología para proteger la privacidad llamada [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/) que combina encriptación y un servidor proxy para esconder su dirección IP y otra información identificativa. Su consulta de búsqueda en tiempo real, junto con datos técnicos, de interacción y de ubicación determinada por IP, pasan por defecto a través de este proxy OHTTP antes de ser enviados a Mozilla. Esto ayuda a evitar que cualquiera (incluida Mozilla) pueda asociar su consulta específica con usted, o que se combine con información no relacionada sobre su actividad de navegación. Mozilla procesa estos datos para ofrecerle sugerencias apropiadas, comprender lo útiles que son las sugerencias para usted y mejorar el servicio. En algunas circunstancias, los socios de Mozilla recibirán datos de búsqueda e interacción desidentificados para ofrecer sugerencias relevantes y medir la interacción del usuario con el contenido sugerido.

Algunos usuarios, incluidos los usuarios en algunas regiones fuera de los EE. UU. y usuarios con base en los EE. UU. que deseleccionan «recuperar Sugerencias de Mozilla mientras usted escribe» en sus ajustes, recibirán en cambio resultados procesados localmente al usar la función Sugerencias de Firefox. Para estos usuarios, las sugerencias se ofrecerán localmente, usando información almacenada en su dispositivo en su copia de Firefox. Sus datos de interacción y de clic desidentificados para palabras clave de consulta específicas (pero no su consulta de búsqueda) se envían a Mozilla a través de OHTTP para esconder su dirección IP y otra información identificativa. Para las sugerencias patrocinadas, nuestros socios pueden recibir información agregada sobre cuáles de sus sugerencias se muestran y reciben clics, pero no cuáles usuarios vieron las sugerencias o cuáles palabras clave hicieron que se ofrecieran esas sugerencias. (Si las Sugerencias de Firefox no están disponibles en su región, usted recibirá solo Sugerencias de búsqueda).

### Para brindar contenido relevante y publicidad en Nueva pestaña de Firefox

Firefox muestra contenido en Nueva pestaña, junto con publicidad para apoyar su desarrollo. Usted puede desactivarlas en cualquier momento en los ajustes de su navegador.

Utilizamos datos técnicos, preferencia de idioma y ubicación determinada por IP para ofrecer este contenido (p. ej. para móvil vs. escritorio), idioma y ubicación relevante. Mozilla recopila datos técnicos y de interacción, como la posición, el tamaño, las vistas y los clics en el contenido o anuncios de Nueva pestaña, para comprender cómo interactúan las personas con nuestro contenido y personalizar el futuro contenido, incluido el contenido patrocinado. Estos datos pueden ser compartidos con nuestros socios publicitarios en forma agregada y/o desidentificada.

En algunas regiones, usamos estos datos para construir modelos y agrupar a los usuarios según atributos comunes. Esta agrupación nos ayuda a entender cómo la gente interactúa con nuestro contenido y a personalizar contenido futuro, incluido contenido patrocinado. Usamos procesamiento en el dispositivo y OHTTP para evitar revelar a Mozilla los atributos de cualquier usuario específico. [Más información](https://support.mozilla.org/kb/firefox-new-tab-personalization).

También trabajamos con proveedores publicitarios para entregar contenido patrocinado relevante usando tecnologías programáticas. Con este fin, podemos compartir información limitada y no identificativa, como el tipo de dispositivo, información de ubicación determinada por IP y categoría del contenido visualizado, para ayudar a determinar cuáles anuncios mostrar. No compartimos ninguna información que lo identifique a usted. Usted puede desactivar el contenido patrocinado en los ajustes de Nueva pestaña en cualquier momento.

En algunos casos, cuando los anuncios en Nueva pestaña están habilitados, datos de navegación e interacción adicionales (incluidas las interacciones con nuestros anunciantes) también pueden ser procesados localmente en su dispositivo para medir la eficacia de esos anuncios; la función de [accesos directos](https://support.mozilla.org/kb/about-new-tab-page#w_shortcuts) también usa los datos de navegación localmente en su dispositivo para seleccionar los mejores accesos directos, algunos de los cuales pueden ser patrocinados. Dichos datas solo serán compartidos con Mozilla y/o nuestros socios publicitarios mediante nuestras tecnologías de protección de la privacidad de forma agregada y/o desidentificada.
...
Usted puede desactivar o personalizar cualquiera de esas funciones de Nueva pestaña junto con su procesamiento de datos asociado en los ajustes de su navegador ([Escritorio](https://support.mozilla.org/kb/customize-your-new-tab-page), [Android](https://support.mozilla.org/kb/customize-firefox-home-screen), [iOS](https://support.mozilla.org/kb/customize-firefox-home-ios)). Usted también puede [deshabilitar contenido patrocinado](https://support.mozilla.org/kb/sponsor-privacy) mientras sigue usando el resto de las funciones.
...
Usted tiene la opción de usar un chatbot de IA de terceros que elija para ayudarle con cosas como resumir lo que está leyendo, escribir y hacer lluvia de ideas, sujeto a los [términos de uso y el aviso de privacidad](https://support.mozilla.org/kb/ai-chatbot#w_learn-about-chatbot-providers) del proveedor.
...
*Más detalles, incluyendo cómo ajustar la configuración de sus datos:* Aprenda [cómo quitar o habilitar complementos](https://support.mozilla.org/kb/disable-or-remove-add-ons). También puede revisar el [Aviso de privacidad](https://www.mozilla.org/privacy/websites/) para el [sitio web del complemento](https://addons.mozilla.org/firefox/).

### Para mantener y mejorar las funciones, el rendimiento y la estabilidad

Mozilla realiza [estudios](https://support.mozilla.org/kb/shield) dentro de Firefox y hace disponibles ciertas [funciones experimentales](https://support.mozilla.org/kb/firefox-labs-explore-experimental-features-firefox) a través de Firefox Labs para probar diferentes funciones e ideas antes de ponerlas a disposición de todos los usuarios de Firefox o convertirlas en parte de la oferta principal de Firefox; esto nos permite tomar decisiones más informadas sobre lo que nuestros usuarios quieren y necesitan. Esta investigación utiliza datos técnicos, de rendimiento del sistema, de ubicación determinada por IP, de configuración y de interacción.

También necesitamos procesar datos para mantener Firefox operativo, mejorar las funciones y el rendimiento, e identificar, solucionar y diagnosticar problemas. Para ello utilizamos datos técnicos, de ubicación determinada por IP y de configuración, así como datos de interacción y rendimiento del sistema (como el número de pestañas abiertas, el uso de la memoria o el resultado de procesos automatizados como las actualizaciones). En las raras situaciones en que la información necesaria también incluye datos de navegación limitados (por ejemplo, anotaciones del dominio de nivel superior para el seguimiento del rendimiento de carga de páginas), se transmitirá mediante OHTTP; esto ayuda a evitar que Mozilla le vincule a usted o a su dispositivo con los datos recopilados para este propósito.

En el escritorio y en Android, si Firefox encuentra un problema inesperado, el [Agente de informe da fallos de Mozilla](https://support.mozilla.org/kb/mozillacrashreporter) también le preguntará si usted desea enviarnos información adicional, que puede incluir sitios que estaban abiertos en el momento del fallo y otros datos de navegación. En escritorio y Android, si usted decide enviarnos informes de fallos automáticamente, recopilamos esta información sin solicitárselo cada vez; en iOS, los informes de fallos contienen menos información y se nos envían automáticamente por defecto. Usted puede cambiar su configuración en cualquier momento.

*Más detalles, incluyendo cómo ajustar la configuración de sus datos:* Usted puede [obtener más información](https://support.mozilla.org/kb/shield) sobre los estudios en los que está matriculado y optar por no participar en todos ellos (o en un estudio específico) en cualquier momento, así como optar por participar en las funciones experimentales a través de [Firefox Labs](https://support.mozilla.org/kb/firefox-labs-explore-experimental-features-firefox). También puede [obtener más información](https://support.mozilla.org/kb/technical-and-interaction-data) sobre los datos técnicos y de interacción que procesamos, incluida la forma de desactivarlos.
...
*Más detalles, incluyendo cómo ajustar la configuración de sus datos:* Usted puede actualizar la configuración de recopilación de datos para [Escritorio](https://support.mozilla.org/kb/share-data-mozilla-help-improve-firefox) y [Móvil](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy) en cualquier momento. Note que al deseleccionar «Permitir que Firefox envíe datos técnicos y de interacción a Mozilla» no afectará el [Ping de uso diario](https://support.mozilla.org/kb/usage-ping-settings). Este ping de uso diario nos proporciona únicamente información desidentificada que un usuario está usando Firefox. No está vinculado a ningún otro dato sobre usted y puede ser excluido en la configuración.
...
*Más detalles, incluyendo cómo ajustar la configuración de sus datos:* Obtenga más información sobre qué [datos de medición de campañas](https://support.mozilla.org/kb/desktop-attribution-privacy) se recopilan y comparten, y cómo darse de baja. Firefox no comparte información como su historial de navegación, consultas de búsqueda o contraseñas guardadas con socios tecnológicos de marketing. Mozilla solo recopila los datos necesarios para medir y mejorar nuestras campañas de marketing.

### Para seudonimizar, desidentificar, agregar o anonimizar datos

Como parte de las actividades descritas anteriormente, como comprender el uso de Firefox y medir nuestro marketing, podemos crear datos seudonimizados, desidentificados, agregados o anonimizados. Utilizamos tecnología que es apropiada para las circunstancias, incluyendo la eliminación de identificador, OHTTP o [DAP](https://divviup.org/about/); esto ayuda a evitar que los datos se vinculen con usted. En algunos casos, podemos compartir o publicar datos agregados y anonimizados para facilitar la investigación o como parte de los fines comerciales legales descritos anteriormente (como compartir información agregada con socios publicitarios).

### Para comunicarnos con usted

Dependiendo de sus ajustes (y si usted tiene o no una cuenta de Mozilla), podemos comunicarnos con usted a través de mensajería integrada en productos, enviarle comunicaciones (incluidas las relacionadas con marketing) o pedirle que participe en investigaciones/encuestas, o que responda a las comunicaciones de soporte al cliente. Usted también puede ponerse en contacto con nosotros directamente, por ejemplo para [informar de un sitio roto dentro de Firefox](https://support.mozilla.org/kb/report-breakage-due-blocking#w_what-information-does-mozilla-collect-from-your-report). Cuando usted comunique con nosotros a través de estos métodos, usaremos la información solo para el propósito que usted nos proporcionó. También procesamos datos de interacción relacionados con estas comunicaciones para comprender mejor quién ha recibido nuestros anuncios relacionados con el servicio (como nuevas características, actualizaciones o alertas de seguridad).

Cuando usted visita las páginas de ayuda de Mozilla en relación con Firefox, Mozilla recopila datos técnicos y de interacción sobre su uso de nuestros sitios web según nuestro aviso de [privacidad de sitios web, comunicaciones y cookies de Mozilla](https://www.mozilla.org/privacy/websites/) para permitirnos entender su uso de nuestras páginas de ayuda y soporte y mejorarlas.
...
* Realizar actividades de cumplimiento interno y seguridad, como auditorías y la gestión de la seguridad de la empresa.
...
## Aplicabilidad (versión de Firefox)

Este aviso de privacidad se aplica a la versión más reciente de lanzamiento general de Firefox distribuido por Mozilla. Si usted adquiere Firefox de otro sitio, o está usando una versión anterior, su copia de Firefox puede incluir términos de privacidad distintos.

Las versiones de prelanzamiento de Mozilla de Firefox (que se distribuyen a través de canales como Nightly, Beta, Developer Edition y TestFlight) son plataformas de desarrollo frecuentemente actualizadas con características y estudios experimentales. Además de la recopilación de datos descrita en este Aviso de privacidad, estas versiones pueden enviar de forma predeterminada ciertos tipos de actividad web y datos de bloqueo a Mozilla (y, en algunos casos, a nuestros socios).
...
| Tipo de datos | Descripción | Ejemplos para los usuarios de Firefox |
| ----- | ----- | ----- |
| Datos técnicos | Esta es información sobre el hardware desde el que usted está accediendo a nuestros servicios (como su ordenador, smartphone o tablet), sus configuraciones y su conexión a Firefox. | Tipo de dispositivo, sistema operativo, dirección IP, ISP (proveedor de servicios de Internet). |
...
| Identificadores únicos | Se trata de identificadores únicos, que pueden crearse en distintos momentos para gestionar sus interacciones con el servicio. | Identificadores de cliente, de sesión y de cookie. |
...
| Datos de interacción | Estos son datos sobre cómo usted interactúa con nuestros servicios, como cuántas pestañas tiene abiertas o en qué ha hecho clic. | Cuenta de clics, datos de impresiones, datos de atribución, cuántas búsquedas se realizaron, tiempo en la página, anuncios y clics en mosaicos patrocinados. |
| Datos de navegación | Esta es información sobre sitios web y URL que usted ha visitado. Esto podría incluir categorías de datos de navegación (viajes, compras, redes sociales), dominios de primer nivel (ejemplo.com) o páginas web específicas visitadas. | Categoría de navegación, dominios de nivel superior (TLD), URLs específicas. |
| Datos de búsqueda | Se trata de datos sobre la categoría de búsqueda, palabras clave de búsqueda o consulta de búsqueda de términos buscados. | Categoría de búsqueda (Comida, Viajes), palabras clave («Boston»), término de búsqueda («tiempo actual en Boston»). |
| Contenido | Cuando usted nos lo proporciona, podemos procesar datos como las imágenes cargadas o las respuestas a encuestas. | Imagen cargada, marcadores, comentarios, respuestas a encuestas. |
| Datos de contacto | Cuando usted nos los proporcione, podremos procesar datos sobre cómo contactarle. | Dirección de correo electrónico, número de teléfono. |
...
<table>
    <thead>
        <tr>
            ...
            <th>Más información, incluyendo elegir cómo usted quiere compartir estos datos en Firefox</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td><a id="bookmark-how-we-use-data"></a>Para proporcionarle el navegador Firefox</td>
            <td>
                <ul>
            ...
            <td>También puede aprender más sobre la <a href="https://support.mozilla.org/kb/website-translation">traducción</a> y la <a href="https://support.mozilla.org/kb/pdf-alt-text">adición de texto alternativo a las imágenes en PDF</a>.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Para brindar contenido relevante y publicidad en Nueva pestaña de Firefox</td>
            <td>
                <ul>
                    <li>Datos técnicos</li>
                    <li>Ubicación</li>
            ...
            <td>Usted puede leer más información sobre <a href="https://support.mozilla.org/kb/customize-your-new-tab-page">cómo administrar su página de Nueva pestaña</a>, incluyendo sus <a href="https://support.mozilla.org/kb/sponsor-privacy">ajustes de datos</a>. Usted puede optar por que sus datos no se procesen para fines de personalización o publicidad desactivando la personalización y/o el contenido patrocinado en cualquier momento.</td>
        </tr>
        <tr>
            <td>Para proporcionar cuentas de Mozilla</td>
            <td colspan="3">Ver nuestro <a href="https://www.mozilla.org/privacy/mozilla-accounts/">Aviso de privacidad de cuentas de Mozilla</a></td>
        </tr>
        <tr>
            ...
            <td><strong>Consentimiento</strong>, cuando usted elige habilitar un chatbot de IA.</td>
        ...
        <tr>
            <td>Habilitar complementos (addons.mozilla.org, "AMO"), incluyendo la oferta de sugerencias personalizadas</td>
            <td>
                <ul>
                    <li>Datos técnicos</li>
                    <li>Ubicación</li>
        ...
        <tr>
            ...
            <td>Más informaciones sobre la <a href="https://support.mozilla.org/kb/how-stop-firefox-making-automatic-connections">Lista de bloqueo de actualizaciones y complementos</a>, el <a href="https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work">Servicio de navegación segura de Google</a>, y <a href="https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/">OHTTP</a>.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <p><strong>Interés legítimo</strong>, cuando no sea estrictamente requerido por la ley, en apoyar solicitudes o procesos legales o regulativos, prevenir fraudes y gestionar y proteger nuestros (y de nuestros usuarios) derechos, propiedad y/o seguridad.</p>
            </td>
