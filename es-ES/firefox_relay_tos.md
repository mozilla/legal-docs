...
__Su uso del Servicio.__ Mozilla le da permiso para usar Firefox Relay de acuerdo con estas Condiciones del Servicio. Este permiso es únicamente para su uso personal. No se le permite transferir, sublicenciar, revender o explotar comercialmente el Servicio. Además, usted acepta que su uso del Servicio se regirá por la [Política de Uso Aceptable](https://www.mozilla.org/about/legal/acceptable-use/) de Mozilla. Usted es el único responsable del Contenido que transfiere, así como de sus consecuencias.
