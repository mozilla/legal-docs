# Aviso de privacidad de sitios web, comunicaciones y cookies
...
* ** Cuentas y suscripciones**: Algunos sitios web, por ejemplo, [Complementos para Firefox](https://addons.mozilla.org/firefox/), [Relay](https://relay.firefox.com/), [Monitor](https://monitor.firefox.com/), y [MDN](https://developer.mozilla.org/), requieren la creación de una cuenta. Para gestionar las cuentas, usamos las [cuentas de Mozilla](https://www.mozilla.org/privacy/mozilla-accounts/), [GitHub](https://support.github.com/#our-use-of-cookies-and-tracking), o sistemas personalizados; [obtenga más información](https://support.mozilla.org/kb/managing-account-data) acerca de cómo gestionar los datos de su cuenta de Mozilla. Usted recibirá periódicamente correo electrónico en relación con su cuenta o a través de sus suscripciones. Nuestros proveedores de servicios de gestión de correo son [SalesForce](https://www.salesforce.com/company/privacy/), [Amazon Simple Email Service](https://aws.amazon.com/privacy/), [Mailchimp](https://www.intuit.com/privacy/statement/), [SocketLabs](https://www.socketlabs.com/legal/service-privacy/), [Campaign Monitor](https://meetmarigold.com/privacy-notices) o [Braze](https://www.braze.com/company/legal/privacy). Si desea anular una suscripción, use el enlace ubicado en la parte inferior del correo electrónico que corresponda. 
...
* **Correo electrónico**: Nuestras comunicaciones de marketing son opcionales y usted puede cancelar su suscripción desde el pie de página del correo electrónico. Usted puede cancelar su suscripción también a través del [centro de preferencias](https://www.mozilla.org/newsletter/recovery/) (boletines de noticias de Mozilla), la [página de cancelación](https://www.mozillafoundation.org/newsletter/unsubscribe/) (boletines de noticias de Mozilla Foundation), o el [sitio de Thunderbird](https://www.thunderbird.net/newsletter/) (boletín de noticias de Thunderbird).
...
* ** Información de contacto y donaciones**: Utilizamos [Braze](https://www.braze.com/company/legal/privacy), [Salesforce](https://www.salesforce.com/company/privacy/), [Fundraise Up](https://fundraiseup.com/privacy/) y [Campaign Monitor](https://meetmarigold.com/privacy-notices/) para enviar por correo electrónico recibos y almacenar registros, que se conservan durante 10 años a partir de la fecha del último pago. Si usted hace una donación a Mozilla Foundation o Thunderbird, usamos [Fundraise Up](https://fundraiseup.com/privacy/) para gestionar nuestras donaciones y entregar recibos de transacciones a nuestros donantes.
