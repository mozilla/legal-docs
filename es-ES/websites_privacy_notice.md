# Aviso de privacidad sobre sitios web, comunicaciones y cookies
...
* **Procesamiento de pagos**: Excepto para pagos realizados a través de cheque, domiciliación bancaria, giro postal y transferencia bancaria, Mozilla no recibe la información financiera que usted facilita al proveedor tercero para dicho procesamiento (p. ej., Braintree, PayPal, Bitpay y Stripe). Además, foundation.mozilla.org utiliza la herramienta de terceros Fundraise Up para gestionar el pago de las donaciones.
