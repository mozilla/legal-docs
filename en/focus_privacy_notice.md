...
When you perform a search, your search query, device information and location data will be processed by your default search engine (according to their [applicable Privacy Notice](https://docs.google.com/document/d/1NbMoRIiMaZg1Ubvbu1fuLkuvVreNupOqBQtPMtLBTaY/edit?tab=t.0#bookmark=id.ykprnygzy44h)) to provide your search results. You can also choose to enable your default search engine to provide search suggestions. 

#### Maintain and improve performance and stability

If Focus or Klar (on Android) encounters an unexpected issue, the [Mozilla Crash Reporter](https://support.mozilla.org/en-US/kb/how-send-crash-report-firefox-android) will ask if you wish to send us information, which may include sites that were open at the time of the crash and other browsing data. On iOS, crash reports contain less information and are sent automatically by default; you can [change your iOS settings](https://support.mozilla.org/en-US/kb/ios-crash-reports-pref) at any time. 

#### Improve security 

We use [Google’s Safe Browsing Service](https://support.mozilla.org/en-US/kb/how-does-phishing-and-malware-protection-work) to protect you from malicious downloads and phishing attacks, and validate webpage and technical data with [Certificate Authorities](https://support.mozilla.org/kb/secure-website-certificate). 
...
| Unique identifiers  | These are unique identifiers, which may be created at various times to manage your interactions with the service.  | Client\_id, session\_id.  |
