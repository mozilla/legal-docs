...
If something you shared was removed due to a mistake or misidentification by the copyright owner, you can file a DMCA counter-notice, using the process described on [Mozilla’s copyright page](https://www.mozilla.org/en-US/about/legal/report-infringement/).
