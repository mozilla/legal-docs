# Termos de uso do Firefox Focus e Klar
...
Você concede à Mozilla os direitos necessários para operar o Firefox. Isso inclui processar seus dados das maneiras descritas no [Aviso de privacidade do Firefox Focus e do Klar](https://www.mozilla.org/privacy/firefox-focus/). Inclui ainda uma licença mundial, não exclusiva e livre de royalties, destinada a permitir a execução das ações solicitadas usando o conteúdo inserido no Firefox. Isso não dá à Mozilla nenhum direito de propriedade sobre esse conteúdo.
