...
### Aby zapewnić użytkownikowi usługę Firefox VPN

Jeśli użytkownik zaloguje się na konto Mozilla, może włączyć w przeglądarce Firefox funkcję umożliwiającą ukrycie adresu IP za pośrednictwem serwera proxy („VPN”). Po włączeniu tej funkcji ruch sieciowy przeglądarki Firefox jest kierowany przez serwer pośredniczący, co uniemożliwia dostawcy usług internetowych sprawdzenie, z jakimi serwerami użytkownik się łączy, oraz ukrywa adres IP użytkownika przed odwiedzanymi witrynami. Ta funkcja nie przekierowuje ruchu z innych aplikacji zainstalowanych na urządzeniu i sama w sobie nie zapewnia całkowitej anonimowości podczas przeglądania stron internetowych. Korzystanie z sieci VPN może wpłynąć na komfort przeglądania stron internetowych, m.in. poprzez wyświetlanie treści niedostępnych w regionie użytkownika.

W celu zapewnienia funkcji VPN korzystamy z serwera proxy obsługiwanego w naszym imieniu. Serwer proxy nie ma dostępu do treści stron internetowych ani innych poufnych informacji, takich jak wiadomości czy hasła, i nie gromadzi danych dotyczących odwiedzanych stron internetowych ani ich treści. Przetwarzamy ograniczoną ilość danych technicznych (takich jak wersja klienta, stan połączenia oraz typ urządzenia/system operacyjny) w celu zapewnienia, utrzymania oraz zagwarantowania wydajności i stabilności usługi, a także dane dotyczące interakcji, aby zrozumieć sposób korzystania z funkcji i pomóc we wprowadzaniu ulepszeń.

### Aby zapewniać i ulepszać funkcje wyszukiwania i podpowiedzi
...
W Stanach Zjednoczonych Firefox pobiera podpowiedzi z serwerów firmy Mozilla podczas wpisywania zapytania. Korzystamy z technologii ochrony prywatności o nazwie [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/), która łączy szyfrowanie i serwer proxy w celu ukrycia adresu IP i innych informacji umożliwiających identyfikację użytkownika. Wyszukiwane hasła w czasie rzeczywistym, wraz z danymi technicznymi, danymi interakcji i danymi lokalizacji pochodzącymi z adresu IP, są domyślnie przekazywane przez serwer proxy OHTTP przed wysłaniem do firmy Mozilla. Pomaga to zapobiec powiązaniu konkretnego zapytania z użytkownikiem przez kogokolwiek (w tym firmę Mozilla) lub połączeniu go z niepowiązanymi informacjami o aktywności użytkownika w Internecie. Mozilla przetwarza te dane, aby przedstawiać użytkownikowi odpowiednie podpowiedzi, zrozumieć, jak przydatne są one dla użytkownika, oraz ulepszyć usługę. W niektórych okolicznościach partnerzy firmy Mozilla otrzymają zanonimizowane dane dotyczące wyszukiwania i interakcji, aby przedstawiać odpowiednie podpowiedzi i mierzyć zaangażowanie użytkowników w sugerowane treści.

Niektórzy użytkownicy — w tym użytkownicy z niektórych regionów poza Stanami Zjednoczonymi oraz użytkownicy z USA, którzy w swoich ustawieniach odznaczają opcję „pobieraj podpowiedzi z firmy Mozilla podczas wpisywania” — będą zamiast tego otrzymywać wyniki przetwarzane lokalnie podczas korzystania z funkcji podpowiedzi Firefoksa. W przypadku tych użytkowników podpowiedzi będą wyświetlane lokalnie, na podstawie informacji przechowywanych na urządzeniu użytkownika w jego kopii przeglądarki Firefox. Zanonimizowane dane użytkownika dotyczące kliknięć i interakcji dla określonych słów kluczowych zapytania (ale nie samo wyszukiwane hasło) są wysyłane do firmy Mozilla za pośrednictwem OHTTP w celu ukrycia adresu IP i innych informacji umożliwiających identyfikację użytkownika. W przypadku sponsorowanych podpowiedzi nasi partnerzy mogą otrzymywać zbiorcze informacje o tym, które z ich podpowiedzi są wyświetlane i klikane, ale nie o tym, którzy użytkownicy widzieli te podpowiedzi ani które słowa kluczowe spowodowały ich wyświetlenie. (Jeśli podpowiedzi z Firefoksa są niedostępne w regionie użytkownika, użytkownik będzie otrzymywać tylko podpowiedzi wyszukiwania).

### Aby wyświetlać odpowiednie treści i reklamy na stronie Nowa karta przeglądarki Firefox

Firefox wyświetla treści w nowej karcie wraz z reklamami, które wspierają jego rozwój. Użytkownik może je wyłączyć w dowolnym momencie w ustawieniach przeglądarki.

Używamy danych technicznych, preferencji językowych i lokalizacji na podstawie adresu IP, aby wyświetlać te treści w odpowiednim formacie (tj. dla urządzeń mobilnych lub komputerów), języku i odpowiedniej lokalizacji. Mozilla gromadzi dane techniczne i dane dotyczące interakcji, takie jak pozycja, rozmiar, wyświetlenia i kliknięcia treści lub reklam na stronie Nowa karta, aby zrozumieć, w jaki sposób użytkownicy wchodzą w interakcję z naszymi treściami i spersonalizować przyszłe treści, w tym treści sponsorowane. Dane te mogą być udostępniane naszym partnerom reklamowym w formie zbiorczej i/lub pozbawionej elementów umożliwiających identyfikację.

W niektórych regionach wykorzystujemy te dane do tworzenia modeli i grupowania użytkowników na podstawie wspólnych atrybutów. Grupy te pomagają nam zrozumieć, w jaki sposób użytkownicy wchodzą w interakcję z naszymi treściami, oraz spersonalizować przyszłe treści, w tym treści sponsorowane. Korzystamy z przetwarzania na urządzeniu i protokołu OHTTP, aby uniknąć ujawniania firmie Mozilla atrybutów konkretnych użytkowników. [Więcej informacji](https://support.mozilla.org/kb/firefox-new-tab-personalization).

Współpracujemy również z dostawcami reklam, aby dostarczać odpowiednie treści sponsorowane przy użyciu technologii programowych. W tym celu możemy udostępniać ograniczone, nieumożliwiające identyfikacji informacje — takie jak typ urządzenia, informacje o lokalizacji uzyskane na podstawie adresu IP oraz kategoria wyświetlanych treści — aby pomóc w określeniu, które reklamy mają być wyświetlane. Nie udostępniamy żadnych informacji umożliwiających identyfikację użytkownika. W każdej chwili użytkownik może wyłączyć treści sponsorowane w ustawieniach nowej karty.

W niektórych przypadkach, gdy reklamy są włączone na nowej karcie, dodatkowe dane dotyczące przeglądania i interakcji (w tym interakcje z naszymi reklamodawcami) mogą być również przetwarzane lokalnie na urządzeniu użytkownika w celu pomiaru skuteczności tych reklam; funkcja [skrótów](https://support.mozilla.org/kb/about-new-tab-page#w_shortcuts)również wykorzystuje dane przeglądania lokalnie na urządzeniu użytkownika do wyboru najlepszych skrótów, z których niektóre mogą być sponsorowane. Wszelkie takie dane będą udostępniane wyłącznie firmie Mozilla i/lub naszym partnerom reklamowym za pośrednictwem naszych technologii ochrony prywatności w formie zagregowanej i/lub pozbawionej elementów umożliwiających identyfikację.
...
W ustawieniach przeglądarki ([komputer](https://support.mozilla.org/kb/customize-your-new-tab-page), [Android](https://support.mozilla.org/kb/customize-firefox-home-screen), [iOS](https://support.mozilla.org/kb/customize-firefox-home-ios)) można wyłączyć lub dostosować dowolną z tych funkcji nowej karty wraz z powiązanym przetwarzaniem danych. Można również [wyłączyć treści sponsorowane](https://support.mozilla.org/kb/sponsor-privacy), nadal korzystając z pozostałych funkcji.
...
Przetwarzamy również dane techniczne i dane ustawień w celu ochrony przed złośliwymi dodatkami.
Oprócz tych standardowych procesów korzystamy z [usługi bezpiecznego przeglądania Google](https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work), aby chronić użytkownika przed złośliwymi plikami do pobrania i atakami phishingowymi, a także weryfikujemy strony i dane techniczne za pomocą [urzędów certyfikacji](https://support.mozilla.org/kb/secure-website-certificate). W ramach naszej pracy nad poprawą prywatności i bezpieczeństwa wszystkich użytkowników Internetu zbieramy dane techniczne za pośrednictwem OHTTP, aby lepiej zrozumieć, zapobiegać i bronić się przed tworzeniem odcisków palców (fingerprinting).
...
*Więcej szczegółów, w tym sposób dostosowania ustawień danych:* [Aktualizacje i lista zablokowanych dodatków](https://support.mozilla.org/kb/how-stop-firefox-making-automatic-connections), [usługa bezpiecznego przeglądania Google](https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work), [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/).
...
*Więcej szczegółów, w tym sposób dostosowania ustawień danych:* Dowiedz się więcej o [danych pomiaru kampanii](https://support.mozilla.org/kb/desktop-attribution-privacy), które są gromadzone i udostępniane, a także jak zrezygnować. Firefox nie udostępnia partnerom marketingowym informacji takich jak historia przeglądania, zapytania wyszukiwania czy zapisane hasła. Mozilla gromadzi wyłącznie dane niezbędne do mierzenia i ulepszania naszych kampanii marketingowych.

### Aby pseudonimizować, deidentyfikować, agregować lub anonimizować dane

W ramach działań opisanych powyżej, takich jak zrozumienie korzystania z przeglądarki Firefox i pomiar naszych działań marketingowych, możemy tworzyć dane pseudonimizowane, deidentyfikowane, zagregowane lub zanonimizowane. Używamy technologii odpowiednich do okoliczności, w tym usuwania identyfikatorów, OHTTP lub [DAP](https://divviup.org/about/) – pomagają one zapobiec powiązaniu danych z użytkownikiem. W niektórych przypadkach możemy udostępniać lub publikować zagregowane i zanonimizowane dane w celu ułatwienia badań lub w ramach zgodnych z prawem celów biznesowych opisanych powyżej (takich jak udostępnianie zagregowanych informacji partnerom reklamowym).

### Aby komunikować się z użytkownikiem

W zależności od ustawień użytkownika (oraz od tego, czy użytkownik posiada konto Mozilla), możemy komunikować się z użytkownikiem za pośrednictwem wiadomości w produkcie, wysyłać mu wiadomości (w tym wiadomości marketingowe) lub prosić go o udział w badaniach/ankietach lub odpowiadanie na wiadomości działu obsługi klienta. Użytkownik może również skontaktować się z nami bezpośrednio, na przykład w celu [zgłoszenia niedziałającej strony w przeglądarce Firefox](https://support.mozilla.org/kb/report-breakage-due-blocking#w_what-information-does-mozilla-collect-from-your-report). Gdy użytkownik komunikuje się z nami za pośrednictwem tych metod, wykorzystamy udostępnione informacje wyłącznie w celu, w jakim zostały przekazane. Przetwarzamy również dane dotyczące interakcji związane z tą komunikacją, aby lepiej zrozumieć, kto otrzymał nasze ogłoszenia związane z usługami (takie jak nowe funkcje, aktualizacje lub alerty bezpieczeństwa).

Kiedy użytkownik odwiedza strony pomocy firmy Mozilla związane z Firefoksem, Mozilla gromadzi dane techniczne i dane dotyczące interakcji na temat korzystania z witryny przez użytkownika zgodnie z informacjami dotyczącymi [witryn, komunikacji i plików cookie firmy Mozilla](https://www.mozilla.org/privacy/websites/), abyśmy mogli zrozumieć sposób korzystania z naszych stron wsparcia i pomocy oraz je ulepszyć.
...
## Zastosowanie (wersja przeglądarki Firefox)
...
| Unikatowe identyfikatory | Są to unikatowe identyfikatory, które mogą być tworzone w różnych momentach w celu zarządzania interakcjami użytkownika z usługą. | Client_id, session_id, identyfikatory plików cookie. |
...
| Dane interakcji | Są to dane dotyczące sposobu, w jaki użytkownik korzysta z naszych usług, takie jak liczba otwartych kart lub kliknięć. | Liczby kliknięć, dane dotyczące wyświetleń, dane dotyczące atrybucji, liczba przeprowadzonych wyszukiwań, czas spędzony na stronie, kliknięcia reklam i kafelków sponsorowanych. |
| Dane przeglądania | Są to informacje o odwiedzanych stronach internetowych i adresach URL. Mogą one obejmować kategorie danych przeglądania (podróże, zakupy, media społecznościowe), domeny najwyższego poziomu (example.com) lub konkretne odwiedzone strony internetowe. | Kategoria przeglądania, domeny najwyższego poziomu (TLD), określone adresy URL. |
| Dane wyszukiwania | Są to dane dotyczące kategorii wyszukiwania, wyszukiwanych słów kluczowych lub wyszukiwanych haseł. | Kategoria wyszukiwania (Jedzenie, Podróże), słowa kluczowe („Boston”), wyszukiwane hasło („aktualna pogoda w Bostonie”). |
| Zawartość | Gdy użytkownik nam ją udostępni, możemy przetwarzać dane, takie jak przesłane obrazy lub odpowiedzi na ankiety. | Przesłany obraz, zakładki, komentarze, odpowiedzi na ankiety. |
| Dane kontaktowe | Gdy użytkownik nam je przekaże, możemy przetwarzać dane dotyczące sposobu kontaktowania się z nim. | Adres e-mail, numer telefonu. |
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Możesz także dowiedzieć się więcej o <a href="https://support.mozilla.org/kb/website-translation">tłumaczeniu</a> i <a href="https://support.mozilla.org/kb/pdf-alt-text">dodawaniu tekstu alternatywnego do obrazów w plikach PDF</a>.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Możesz dowiedzieć się więcej na temat <a href="https://support.mozilla.org/kb/how-stop-firefox-making-automatic-connections">aktualizacji i listy zablokowanych dodatków</a>. <a href="https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work">bezpiecznego przeglądania Google</a> oraz <a href="https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/">OHTTP</a>.</td>
        </tr>
        <tr>
