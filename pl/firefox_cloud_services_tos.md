...
3. #### Usługi 
    ...
    (a) Mozilla VPN to wirtualna sieć prywatna obsługiwana we współpracy z firmą [Mullvad](https://mullvad.net/). Wymagane jest konto Firefox.
    
    (b) Funkcja Firefox Relay umożliwia zachowanie bezpieczeństwa i prywatności głównego adresu e-mail w usługach internetowych dzięki tworzeniu unikatowych aliasów adresu e-mail, które pozwalają na wysyłanie i odbieranie wiadomości e-mail bez ujawniania głównego adresu e-mail. Wymagane jest konto Firefox.
    ...
    * Wskazówki dotyczące bezpieczeństwa: Ta usługa umożliwia otrzymywanie od czasu do czasu porad w zakresie bezpieczeństwa korzystania z Internetu od firmy Mozilla.
    ...
    (e) Funkcja Firefox Sync umożliwia dostęp za pośrednictwem wielu urządzeń do informacji zapisanych w przeglądarce Firefox, między innymi kart, dodatku awesome bar, haseł, zakładek i preferencji przeglądarki. Funkcję Firefox Sync można włączać i wyłączać z poziomu sekcji Ustawienia w przeglądarce Firefox. Wymagane jest konto Firefox. 
...
8. #### Okres obowiązywania; wypowiedzenie
    ...
    Niniejsze Warunki obowiązują do momentu ich wypowiedzenia przez użytkownika lub firmę Mozilla. Użytkownik może wypowiedzieć umowę w dowolnym momencie, usuwając konto Firefox, zaprzestając korzystania z Usług oraz, zależnie od przypadku, rezygnując z subskrypcji naszych wiadomości e-mail. 
