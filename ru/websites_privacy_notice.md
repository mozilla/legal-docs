...
* **Обработка платежей**: за исключением платежей, осуществляемых с помощью чека, прямого дебетования, почтового и электронного перевода, Mozilla не получает никакой финансовой информации, которая передается от вас указанному стороннему поставщику для обработки (например, Braintree, PayPal, Bitpay или Stripe). Кроме того, Фонд foundation.mozilla.org использует стороннюю организацию Fundraise Up для управления поступающими пожертвованиями.
