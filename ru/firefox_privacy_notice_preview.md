...
<a class="link-current-pn" href="https://www.mozilla.org/privacy/firefox/">Для знакомства с нашим текущим уведомлением нажмите здесь.</a>
...
Если вы решите включить функцию Shake to Summarize для создания кратких сводок сайтов в мобильном браузере Firefox на устройстве с Apple Intelligence (iPhone 15 Pro+ с iOS 26+), сводки будут создаваться локально на вашем устройстве по вашему запросу. Если вы включите эту функцию на устройстве без Apple Intelligence, содержимое вашей страницы будет отправлено на сервер Mozilla для обработки при запросе сводки, а сводка будет возвращена на ваше устройство; Mozilla не хранит этот контент или полученные сводки.
...
### Соблюдение действующего законодательства, а также выявление и предотвращение вредоносной, несанкционированной или незаконной
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <p><strong>Законный интерес</strong> в случаях, если соблюдение требований нецелесообразно, в поддержке юридических или нормативных процессов или запросов, предотвращении мошенничества, а также управлении и защите наших прав (и прав наших пользователей), а также собственности и/или безопасности.</p>
            </td>
