...
* __Поисковые запросы__: Firefox отправляет Mozilla то, что вы вводите в строку поиска, а Mozilla может делиться этими данными со своими [партнерами](https://support.mozilla.org/kb/firefox-suggest?as=u&utm_source=inproduc#w_who-are-mozillas-partners). 

* __Посещаемые вами сайты__: Для Подсказок, на которые вы нажимаете, Firefox отправляет в Mozilla URL-адрес веб-сайта, и Mozilla может поделиться этими данными со своими [партнерами](https://support.mozilla.org/kb/firefox-suggest?as=u&utm_source=inproduc#w_who-are-mozillas-partners).
