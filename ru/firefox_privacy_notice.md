...
*Дата вступления в силу: 30 сентября 2021 г.*
{: datetime="2021-09-30" }
...
Компания Mozilla разрабатывает новую функцию, которая помогает предоставлять вам более точную информацию с меньшими усилиями. Она называется Firefox Suggest, и ее ранняя версия в настоящее время доступна пользователям в США. Firefox Suggest показывает вам рекомендованный и спонсируемый контент. Мы принимаем меры, чтобы ограничить возможность нашей и наших партнеров идентифицировать вас. [Подробнее о функции](https://support.mozilla.org/en-US/kb/navigate-web-faster-firefox-suggest?as=u&utm_source=inproduc), в том числе об отключении этой функции.

Для улучшения вашей работы в Интернете и повышения качества продукта браузер Firefox предоставляет следующую информацию:
