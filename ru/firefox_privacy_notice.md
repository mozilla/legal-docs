...
Дата вступления в силу: 4 мая 2026 г.
{: datetime="2026-05-04" }
...
Некоторые функции Firefox, такие как автоматический [перевод](https://support.mozilla.org/kb/website-translation) веб-страниц и [генерирование альтернативного текста при загрузке изображений в PDF-файлы](https://support.mozilla.org/kb/pdf-alt-text), работают на основе искусственного интеллекта (ИИ) с использованием небольших языковых моделей, загруженных на ваше устройство. Они работают локально — контент веб-страниц, PDF-файлы, изображения и URL-адреса вкладок остаются на вашем устройстве и не отправляются на серверы Mozilla или не используются в учебных целях без вашего явного согласия. Обратите внимание, что другие функции Firefox могут интегрировать сторонние модели искусственного интеллекта, что более подробно описано в настоящем Уведомлении. Подробнее о том, как [управлять функциями](https://support.mozilla.org/kb/firefox-ai-controls) и моделями на основе ИИ в настройках.

Если вы решите использовать функцию Smart Window, на использование вами этой функции будет распространяться [Политика конфиденциальности Smart Window](https://www.mozilla.org/privacy/smart-window/), в которой объясняется, как обрабатываются данные в рамках использования Smart Window.

### Адаптация браузера Firefox к вашим нуждам
...
Если вы включите функцию Shake to Summarize для создания кратких сводок сайтов при помощи ИИ на совместимом устройстве, работающем под управлением поддерживаемой ОС с встроенным ИИ, запрошенные вами сводки будут создаваться локально на вашем устройстве. Либо при запросе сводки контент вашей страницы будет отправлен на сервер Mozilla для обработки и возвращен на ваше устройство. Mozilla не хранит этот контент или полученные сводки. Подробнее о функции Shake to Summarize на [iOS](https://blog.mozilla.org/en/firefox/shake-to-summarize/) и [Android](https://support.mozilla.org/kb/summarize-pages-android).

*Более подробная информация, включая информацию о том, как изменить настройки использования данных:* Данные, обрабатываемые на вашем устройстве, остаются под вашим контролем. Вы можете [управлять данными браузера](https://support.mozilla.org/kb/delete-browsing-search-download-history-firefox) и [настройками локального хранилища](https://support.mozilla.org/kb/storage), а также [обновлять разрешения на доступ к местоположению](https://support.mozilla.org/kb/does-firefox-share-my-location-websites) в любое время.

### Предоставление Firefox VPN

Если вы вошли в свою учетную запись Mozilla, вы можете включить функцию Firefox, позволяющую скрывать свой IP-адрес через прокси-сервер («VPN»). При включении этой функции сетевой трафик Firefox перенаправляется через посредника, чтобы ваш интернет-провайдер не мог видеть, к каким серверам вы подключаетесь, и чтобы ваш IP-адрес был скрыт от посещаемых вами сайтов. Она не перенаправляет трафик из других приложений на устройстве и сама по себе не обеспечивает полную анонимность при просмотре сайтов. Использование VPN может повлиять на качество просмотра веб-страниц, в том числе из-за показа контента, не соответствующего вашему региону.

Для обеспечения работы функции VPN мы используем прокси-сервер, управляемый от нашего имени. Прокси-сервер не имеет доступа к контенту веб-страниц или другой конфиденциальной информации, такой как сообщения или пароли, и не собирает данные о посещаемых вами сайтах или их контенте. Мы обрабатываем ограниченный объем технических данных (таких как версия клиента, статус подключения и тип устройства/операционная система) для обеспечения, поддержки и гарантирования производительности и стабильности сервиса, а также данные о взаимодействии, чтобы понимать использование функции и помогать в ее улучшении.

### Обеспечение и улучшение функции поиска и поисковых подсказок

Когда вы вводите поисковый запрос в Firefox, браузер Firefox предлагает [поисковые подсказки](https://support.mozilla.org/kb/search-suggestions-firefox), которые обеспечивают вам более быстрый и прямой доступ к тому, что вы ищете. Некоторые поисковые предложения исходят от вашего поискового провайдера («Поисковые подсказки»). Другие поступают из Firefox и основаны на информации, хранящейся на вашем локальном устройстве (включая последние поисковые запросы, открытые вкладки и ранее посещенные URL-адреса), или на контенте от Mozilla и партнеров Mozilla, включая платных спонсоров и интернет-ресурсы, такие как Wikipedia («Поисковые подсказки от Firefox»).

По умолчанию Firefox показывает поисковые подсказки. Запросы на поисковые подсказки, включая ваш поисковой запрос в реальном времени и технические данные, отправляются непосредственно вашему поставщику поиска по мере ввода текста и обрабатываются в соответствии с уведомлением о конфиденциальности вашего поставщика поиска ([ссылка приведена ниже](#bookmark-search-pns)). Вы можете отключить функцию «Поисковые подсказки» или изменить поисковую систему по умолчанию в любое время, как описано на этой странице [поддержки Firefox](https://support.mozilla.org/kb/firefox-suggest).

Пользователи в США и некоторых других регионах также будут получать поисковые подсказки от Firefox. Вы можете полностью отключить их или просто отключить спонсируемые поисковые подсказки от Firefox в настройках своего браузера.

В США Firefox получает поисковые подсказки с серверов Mozilla по мере ввода запроса. Мы используем технологию сохранения конфиденциальности [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/), которая сочетает в себе шифрование и прокси-сервер для скрытия вашего IP-адреса и другой идентифицирующей информации. Ваш поисковый запрос в режиме реального времени, а также технические данные, данные о взаимодействии и данные о местоположении по IP по умолчанию передаются через этот прокси-сервер OHTTP перед отправкой в ​​Mozilla. Это помогает предотвратить возможность того, что кто-либо (включая Mozilla) свяжет ваш конкретный запрос с вами или объединит его с посторонней информацией о ваших действиях в браузере. Mozilla обрабатывает эти данные, чтобы предлагать вам релевантные предложения, понимать, насколько эти предложения полезны для вас, и повышать уровень обслуживания. В некоторых случаях партнеры Mozilla будут получать обезличенные данные поиска и взаимодействия с целью предоставления релевантных предложений и оценки взаимодействия пользователей с предлагаемым контентом.

Некоторые пользователи, включая пользователей из некоторых регионов за пределами США и пользователей из США, которые сняли флажок «получать предложения от Mozilla по мере ввода текста» в своих настройках, вместо этого будут получать локально обработанные результаты при использовании функции «Поисковые подсказки от Firefox». Для этих пользователей поисковые подсказки будут отображаться локально, с использованием информации, хранящейся на вашем устройстве, в вашей копии Firefox. Ваши обезличенные данные о кликах и взаимодействиях по определенным ключевым словам запроса (но не по вашему поисковому запросу) отправляются в Mozilla через OHTTP для скрытия вашего IP-адреса и другой идентифицирующей информации. В случае спонсируемых поисковых подсказок наши партнеры могут получать обобщенную информацию о том, какие из их предложений были показаны и по каким ссылкам кликнули, но не о том, какие пользователи увидели эти предложения или какие ключевые слова привели к показу этих поисковых подсказок. (Если в вашем регионе недоступны подсказки от Firefox, вы будете получать только Поисковые подсказки).

### Показ соответствующего контента и рекламы в Новой вкладке Firefox

Firefox показывает контент на Новой вкладке вместе с рекламой для поддержки своего развития. Вы можете изменить или отключить эту функцию в любое время в настройках браузера.

Мы используем технические данные, языковые настройки и местоположение по IP-адресу для предоставления этого контента в правильном формате (т. е. для мобильных устройств и настольных компьютеров), на соответствующем языке и в соответствующем местоположении. Mozilla собирает технические и интерактивные данные, такие как положение, размер, просмотры и клики по контенту или рекламе новой вкладки, чтобы понять, как люди взаимодействуют с нашим контентом, и персонализировать будущий контент, включая спонсируемый контент. Эти данные могут быть переданы нашим рекламным партнерам в агрегированном и/или обезличенном виде.

В некоторых регионах мы используем эти данные для построения моделей и группировки пользователей на основе общих признаков. Эти группы помогают нам понять, как люди взаимодействуют с нашим контентом, и персонализировать будущий контент, включая спонсируемый контент. Мы используем обработку на устройстве и OHTTP, чтобы не раскрывать Mozilla атрибуты конкретного пользователя. [Подробнее](https://support.mozilla.org/kb/firefox-new-tab-personalization).

Мы также работаем с провайдерами рекламы для предоставления релевантного спонсируемого контента с использованием программных технологий. Для этого мы можем предоставлять ограниченную неидентифицирующую информацию, например тип устройства, информацию о местоположении по IP-адресу и категорию просмотренного контента, чтобы помочь определить, какую рекламу показывать. Мы не передаем никакую информацию, позволяющую идентифицировать вашу личность. Вы можете в любое время отключить спонсируемый контент в настройках Новой вкладки.

В некоторых случаях, когда в Новой вкладке включены рекламные объявления, дополнительные данные о просмотре и взаимодействии (включая взаимодействие с нашими рекламодателями) могут также обрабатываться локально на вашем устройстве для оценки эффективности этих объявлений. Функция [ярлыков](https://support.mozilla.org/kb/about-new-tab-page#w_shortcuts) также использует данные о просмотре локально на вашем устройстве для выбора лучших ярлыков, некоторые из которых могут быть спонсируемыми. Любые такие данные будут передаваться Mozilla и/или нашим рекламным партнерам только с использованием наших технологий сохранения конфиденциальности на агрегированной и/или обезличенной основе.
...
Вы можете отключить или настроить любую из этих функций Новой вкладки, а также связанную с ними обработку данных в настройках своего браузера (для [ПК](https://support.mozilla.org/kb/customize-your-new-tab-page), [Android](https://support.mozilla.org/kb/customize-firefox-home-screen) и [iOS](https://support.mozilla.org/kb/customize-firefox-home-ios)). Вы также можете [отключить спонсируемый контент](https://support.mozilla.org/kb/sponsor-privacy), продолжая использовать остальные функции.
...
*Более подробная информация, включая информацию о том, как изменить настройки использования данных:* Подробнее о том, как [управлять чат-ботами на основе искусственного интеллекта в Firefox или удалять](https://support.mozilla.org/kb/ai-chatbot) их.

### Предоставление и включение дополнений (addons.mozilla.org)

Вы можете установить дополнения на сайте [addons.mozilla.org](https://addons.mozilla.org) (АМО) или воспользоваться диспетчером дополнений Firefox, который доступен в меню на панели инструментов Firefox. Мы обрабатываем ваши поисковые запросы в Диспетчере дополнений, чтобы иметь возможность предлагать вам дополнительные компоненты. Если вы решите установить какие-либо дополнения, Firefox будет обрабатывать технические данные, данные о местоположении и настройках на базе IP-адреса, а также периодически подключаться к серверам Mozilla для установки и применения соответствующих обновлений к вашим дополнениям. Мы также собираем технические и интерактивные данные об использовании дополнений, чтобы помочь улучшить Firefox.
...
В дополнение к этим стандартным процессам мы используем [Сервис безопасного поиска Google](https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work), чтобы защитить вас от вредоносных загрузок и фишинговых атак, а также проверяем веб-страницы и технические данные с помощью [Центров сертификации](https://support.mozilla.org/kb/secure-website-certificate). В рамках нашей работы по улучшению конфиденциальности и безопасности всех интернет-пользователей мы собираем технические данные через OHTTP, чтобы лучше понимать, предотвращать и защищаться от сканирования отпечатков пальцев.
...
*Более подробная информация, включая информацию о том, как изменить настройки использования данных:* Вы можете обновить настройки сбора данных для  [ПК](https://support.mozilla.org/kb/share-data-mozilla-help-improve-firefox) и [мобильных устройств](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy) в любое время. Обратите внимание, что снятие флажка «Разрешить Firefox отправлять технические и интерактивные данные в Mozilla» не повлияет на [ежедневный пинг использования](https://support.mozilla.org/kb/usage-ping-settings). Сервис Daily Usage Ping предоставляет нам исключительно обезличенную информацию о том, что пользователь использует Firefox. Он не связан с какими-либо другими данными о вас и может быть отключен в настройках.

### Продвижение наших услуг

Если вы разрешаете нам это делать, Firefox отправляет в Mozilla данные о домене веб-сайта или конкретной рекламной кампании (если таковая имеется), которая перенаправила вас на нашу страницу загрузки, чтобы помочь нам понять и улучшить наши маркетинговые усилия. Firefox также делится информацией с нашими маркетинговыми партнерами для оценки и улучшения этих кампаний; то, какая именно информация передается, зависит от того, как вы узнали о Firefox и вашей операционной системе, но, как правило, включает в себя информацию о том, как вы попали на нашу страницу загрузки и используете ли вы Firefox активно. Когда на вашем устройстве предустановлен браузер Firefox, технические данные и данные о взаимодействии (тип вашего устройства и используется ли Firefox) будут отправлены нашим маркетинговым партнерам и переданы в Mozilla.

*Более подробная информация, включая информацию о том, как изменить настройки использования данных:* Узнайте больше о том, какие [данные об Измерении кампании](https://support.mozilla.org/kb/desktop-attribution-privacy)собираются и передаются, а также как отказаться от данных сервисов. Firefox не передает такую ​​информацию, как история просмотров, поисковые запросы или сохраненные пароли, партнерам по маркетинговым технологиям. Mozilla собирает только те данные, которые необходимы для оценки и улучшения наших маркетинговых кампаний.

### Псевдонимизация, деидентификация, агрегация или анонимизация данных

В рамках описанных выше мероприятий, таких как изучение использования Firefox и измерение наших маркетинговых усилий, мы можем создавать псевдонимные, обезличенные, агрегированные или анонимные данные. Мы используем технологии, соответствующие обстоятельствам, включая удаление идентификатора, OHTTP или [DAP](https://divviup.org/about/) — они помогают предотвратить привязку данных к вам. В некоторых случаях мы можем делиться или публиковать обобщенные и анонимные данные для содействия проведению исследований или в рамках законных бизнес-целей, описанных выше (например, для обмена обобщенными данными с рекламными партнерами).

### Взаимодействие с вами

В зависимости от ваших настроек (а также от того, есть ли у вас учетная запись Mozilla) мы можем общаться с вами посредством сообщений внутри продукта, отправлять вам сообщения (включая маркетинговые сообщения), просить вас принять участие в исследованиях/опросах или отвечать на сообщения службы поддержки клиентов. Вы также можете связаться с нами напрямую, например, чтобы [сообщить о неисправном сайте в Firefox](https://support.mozilla.org/kb/report-breakage-due-blocking#w_what-information-does-mozilla-collect-from-your-report). Когда вы свяжетесь с нами этими способами, мы будем использовать только ту информацию, которую вы предоставите, только в тех целях, для которых вы ее предоставили. Мы также обрабатываем данные о взаимодействии, связанные с этими сообщениями, чтобы лучше понять, кто получил наши объявления, связанные с услугами (например, о новых функциях, обновлениях или оповещениях о безопасности).

Когда вы посещаете страницы справки Mozilla в связи с Firefox, Mozilla собирает технические и интерактивные данные об использовании вами наших веб-сайтов в соответствии с нашим уведомлением [Mozilla](https://www.mozilla.org/privacy/websites/) о веб-сайтах, сообщениях и файлах cookie, чтобы мы могли понять, как вы используете наши страницы поддержки и помощи, и улучшить их.
...
*Ответы на юридические запросы и соблюдение [юридических процедур](https://www.mozilla.org/about/policy/transparency/), например, ответы на повестки, расследования или запросы государственных органов. Mozilla требует наличия действительного юридического процесса для принудительного раскрытия данных конкретного пользователя по запросу государственных органов.
...
| Органы власти | Mozilla требует наличия действительного юридического процесса для принудительного раскрытия данных конкретного пользователя по запросу государственных органов. В таких случаях нам может потребоваться раскрыть персональные данные, указанные в настоящем Уведомлении, правоохранительным органам, государственным органам или аналогичным организациям для соблюдения применимого законодательства, а также для выявления и предотвращения вредоносной, несанкционированной или незаконной деятельности. |
| Исследователи | Когда мы выполняем свою [миссию](https://www.mozilla.org/about/manifesto/) открытости. Иногда мы публикуем информацию, чтобы улучшить наши продукты и способствовать открытости в сети, но когда мы это делаем, мы делаем это в обезличенном и/или агрегированном [формате](https://wiki.mozilla.org/Data_Publishing). |
...
Вы можете обновить настройки сбора данных для  [ПК](https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings) и [мобильных устройств](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy) в любое время.
...
| Тип данных | Описание | Примеры для пользователей Firefox |
| ----- | ----- | ----- |
...
| Данные о посещении сайтов | Это информация о веб-сайтах и ​​URL-адресах, которые вы посетили. Сюда могут входить категории данных о просмотренных страницах (путешествия, покупки, социальные сети), домены верхнего уровня (example.com) или конкретные веб-страницы, которые вы посетили. | Категории просмотра, домены верхнего уровня (TLD), определенные URL-адреса. |
| Данные поисковых запросов | Это данные о категории поиска, ключевых словах поиска или поисковом запросе искомых терминов. | Категория поиска (Еда, Путешествия), ключевые слова («Бостон»), поисковый запрос («текущая погода в Бостоне»). |
...
| Контактные данные | Когда вы предоставляете нам данные, мы можем обрабатывать данные о том, как с вами связаться. | Адрес электронной почты, номер телефона. |
...
<table>
    ...
    <tbody>
        <tr>
            <td><a id="bookmark-how-we-use-data"></a>Предоставление вам браузера Firefox</td>
            <td>
                <ul>
            ...
            <td>Вы также можете узнать больше о <a href="https://support.mozilla.org/kb/website-translation">переводе</a> и <a href="https://support.mozilla.org/kb/pdf-alt-text">добавлении альтернативного текста к изображениям в PDF-файлах</a>.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Вы можете ознакомиться с дополнительной информацией о том, <a href="https://support.mozilla.org/kb/customize-your-new-tab-page">как управлять страницей «Новая вкладка»</a>, включая ваши <a href="https://support.mozilla.org/kb/sponsor-privacy">настройки данных</a>. Вы можете в любое время отказаться от обработки своих данных в целях персонализации или рекламы, отключив персонализацию и/или спонсируемый контент в любое время.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Предоставление чат-ботов с ИИ</td>
            <td>
                <ul>
                    <li>Технические данные</li>
                    <li>Местоположение</li>
        ...
        <tr>
            ...
            <td>Подробнее о том, как мы реагируем на <a href="https://www.mozilla.org/about/policy/transparency/">правовые запросы</a>.</td>
        </tr>
    </tbody>
</table>

<a id="bookmark-search-pns"></a>
## Уведомления о конфиденциальности для отдельных поисковых систем
