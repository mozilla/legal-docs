...
*Дата вступления в силу: 27 июля 2023 г.*
{: datetime="2022-08-01" }
...
* Если вы включите Improve the Firefox Suggest Experience, мы и наши партнеры также можем получать ваши поисковые запросы. [См. детали ниже](#searches). 
...
{: #referraltracking }
    ...
    _С мобильного устройства_: Браузер Firefox для  iOS и Android по умолчанию отправляет данные мобильной кампании нашему поставщику аналитических решений Adjust, который руководствуется собственной [политикой конфиденциальности](https://www.adjust.com/terms/privacy-policy/). Данные мобильной кампании включают рекламный идентификатор Google, Android ID, IP-адрес, временную метку, а также сведения о стране, языке, региональных настройках, операционной системе и версии приложения. Ознакомьтесь с [полной документацией](https://dictionary.telemetry.mozilla.org/apps/fenix?itemType=metrics&page=1&search=adjust).
{: #thirdparty }
...
### Аккаунты Firefox {: #firefox-accounts }
