...
<a class="link-next-pn" href="https://www.mozilla.org/privacy/firefox/next">Мы обновляем наше Уведомление о конфиденциальности. Нажмите здесь, чтобы ознакомиться с новой версией.</a>
...
#### Более подробная информация, включая рекомендации об изменении настроек использования данных

Вы можете ознакомиться с более подробной информацией о данных, которые мы собираем при использовании  [ПК](https://dictionary.telemetry.mozilla.org/apps/firefox_desktop), [Android](https://dictionary.telemetry.mozilla.org/apps/fenix) или [iOS](https://dictionary.telemetry.mozilla.org/apps/firefox_ios). Вы можете обновить настройки сбора данных для  [ПК](https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings) и [мобильных устройств](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy) в любое время.
...
Вы можете ознакомиться с дополнительной информацией о том, [как управлять страницей Новая вкладка ](https://support.mozilla.org/kb/customize-your-new-tab-page), включая настройки использования данных для [ПК](https://support.mozilla.org/kb/sponsor-privacy), [Android](https://support.mozilla.org/kb/customize-firefox-home-screen) или [iOS](https://support.mozilla.org/kb/customize-firefox-home-ios). Вы можете в любое время отказаться от обработки своих данных в целях персонализации или рекламы, отключив на [ПК](https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings) и [мобильных устройствах](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy).
...
Вы можете узнать больше о [списке заблокированных обновлений и дополнений](https://support.mozilla.org/kb/how-stop-firefox-making-automatic-connections), [службе безопасного просмотра Google](https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work) и [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/), а также отключить [технические и интерактивные данные](https://support.mozilla.org/kb/technical-and-interaction-data). 
...
* <a id="bookmark-authorities"></a>Ответы на [юридические запросы](https://www.mozilla.org/about/policy/transparency/#dfn-legal-process) и соблюдение [юридических процедур](https://www.mozilla.org/about/policy/transparency/), например, ответы на повестки, расследования или запросы государственных органов. Mozilla требует наличия действительного юридического процесса для принудительного раскрытия данных конкретного пользователя по запросу государственных органов.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Вы можете ознакомиться с более подробной информацией о данных, которые мы собираем при использовании  <a href="https://dictionary.telemetry.mozilla.org/apps/firefox_desktop">ПК</a>, <a href="https://dictionary.telemetry.mozilla.org/apps/fenix">Android</a> или <a href="https://dictionary.telemetry.mozilla.org/apps/firefox_ios">iOS</a>. Вы можете обновить настройки сбора данных для  <a href="https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings">ПК</a> и <a href="https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy">мобильных устройств</a> в любое время. Вы также можете узнать больше о <a href="https://support.mozilla.org/kb/website-translation">переводе</a> и <a href="https://support.mozilla.org/kb/pdf-alt-text">добавлении альтернативного текста к изображениям в PDF-файлах</a>.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Вы можете ознакомиться с дополнительной информацией о том, <a href="https://support.mozilla.org/kb/customize-your-new-tab-page">как управлять страницей Новая вкладка </a>, включая настройки использования данных для <a href="https://support.mozilla.org/kb/sponsor-privacy">настольных компьютеров</a>, <a href="https://support.mozilla.org/kb/customize-firefox-home-screen">Android</a> или <a href="https://support.mozilla.org/kb/customize-firefox-home-ios">iOS</a>. Вы можете в любое время отказаться от обработки своих данных в целях персонализации или рекламы, отключив на <a href="https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings">ПК</a> и <a href="https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy">мобильных устройствах</a>.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Вы можете узнать больше о списке <a href="https://support.mozilla.org/kb/how-stop-firefox-making-automatic-connections">заблокированных обновлений и дополнений</a>, <a href="https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work">службе безопасного просмотра Google</a> и <a href="https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/">OHTTP</a>, а также отключить <a href="https://support.mozilla.org/kb/technical-and-interaction-data">технические и интерактивные данные</a>.</td>
        </tr>
        <tr>
