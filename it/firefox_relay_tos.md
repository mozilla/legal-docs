...
__Utilizzo del Servizio.__ Mozilla ti permette di usare il Firefox Relay in base ai presenti Termini di servizio. Questa autorizzazione si estende esclusivamente all'uso personale. Non puoi trasferire, rivendere, concedere in sublicenza o sfruttare commercialmente il Servizio. Accetti inoltre di utilizzare il Servizio conformemente all'[Informativa sul corretto utilizzo](https://www.mozilla.org/about/legal/acceptable-use/) di Mozilla. Sei responsabile in prima persona dei Contenuti che trasmetti e delle conseguenze che ne derivano.
