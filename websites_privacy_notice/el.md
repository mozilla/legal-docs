...
* **Αναλυτική και βελτιστοποίηση**: Ακολουθήστε τις παρακάτω οδηγίες για να αποτρέψετε τη συλλογή δεδομένων κατά τις επισκέψεις σας σε ιστοσελίδες της Mozilla:
    ...
    *  Optimizely: [Δηλώστε τη μη επιθυμία σας στο www.mozilla.org](https://www.mozilla.org/?optimizely_opt_out=true) ή επισκεφθείτε την [ιστοσελίδα δήλωσης μη επιθυμίας καταγραφής του Optimizely](https://www.optimizely.com/opt_out) για περισσότερες πληροφορίες.
