...
*Gültig ab Donnerstag, 27. Juli 2023*
{: datetime="2022-08-01" }
...
### Verbessern der Leistung und Stabilität für Nutzer weltweit {: #health-report }
...
* __Suchanfragen__: Firefox sendet Suchanfragen standardmäßig an Ihren Suchanbieter, damit Sie Suchbegriffe entdecken, nach denen andere Benutzer bereits häufig gesucht haben, und um Ihre Sucherfahrung zu verbessern, sofern Ihr Suchanbieter Suchempfehlungen unterstützt. Wenn Sie die Dienste eines Suchanbieters in Anspruch nehmen, unterliegen Erfassung und Verarbeitung Ihrer Daten im Rahmen der Suche der Datenschutzerklärung des ausgewählten Suchanbieters. [Weitere Informationen](https://support.mozilla.org/kb/search-suggestions-firefox), darunter Angaben dazu, wie Sie diese Funktion deaktivieren können. Links zu den Datenschutzerklärungen unserer Standard-Suchanbieter. Dazu gehören:

  * [Google](https://policies.google.com/privacy)
  * [Microsoft (Bing)](https://privacy.microsoft.com/privacystatement)
  
Mozilla erhält in der Regel ein Entgelt, wenn Sie in Ihrem Firofox-Browser eine als Standard vorgegebene oder eine optionale Suchoption nutzen. Dazu gehören unter anderem die Dienste Google, Bing, DuckDuckGo und eBay.
...
* __Technische und Interaktionsdaten__: Firefox sendet uns Daten wie die Position, Größe und Platzierung von uns vorgeschlagener Inhalte sowie grundlegende Daten zu Ihren Interaktionen mit solchen Inhalten. Dies umfasst Angaben dazu, wie oft empfohlene Inhalte angezeigt werden oder darauf geklickt wird.

* __Pocket-Empfehlungen__: Wir empfehlen Ihnen Inhalte auf Grundlage Ihrer Browserchronik, Sprache und des Landes, in dem Sie sich befinden. Der Prozess zur Entscheidung, welche Inhalte Sie basierend auf Ihrer Browserchronik sehen, erfolgt lokal in Ihrer Kopie von Firefox. Weder Mozilla noch Pocket erhalten eine Kopie Ihrer Browserchronik. Damit Sie je nach Ihrem Standort relevante Pocket-Empfehlungen sehen, teilt Firefox Ihre Sprach- und Ländereinstellung mit Pocket.

    Mozilla und Pocket erhalten aggregierte Daten zu den Empfehlungen, die Ihnen angezeigt werden und auf die Sie klicken. Außerdem teilen wir aggregierte Daten über die gesponserten Inhalte, die Ihnen angezeigt werden und auf die Sie klicken, mit unserer Drittanbieter-Anzeigenplattform Kevel, damit Werbetreibende sehen können, wie viele Personen auf ihre Artikel klicken. Über diese aggregierten Daten können Sie als Person nicht identifiziert werden.
...
* __Sensible Daten__:  Absturzberichte enthalten eine sog. „Dump-Datei“ mit dem Arbeitsspeicherinhalt von Firefox zum Zeitpunkt des Absturzes. Diese Datei kann Daten enthalten, die Rückschlüsse auf Ihre Identität zulassen oder auf sonstige Weise für Sie sensibel sein können.
...
* __Websites, die Sie besuchen__: Firefox sendet Mozilla, welche Vorschläge Sie anklicken und welche Sie ablehnen. Mozilla ist berechtigt, diese Daten mit seinen [Partnern](https://support.mozilla.org/kb/firefox-suggest#w_who-are-mozillas-partners) zu teilen.

* __Standortdaten__: Firefox sendet Mozilla vorübergehend Ihre IP-Adresse. Diese verwenden wir, um Inhalte basierend auf Ihrem Land, Ihrem Bundesland/Kanton und Ihrer Stadt vorzuschlagen. Mozilla ist berechtigt, Standortinformationen – nicht jedoch Ihre IP-Adresse – mit unseren Partnern zu teilen. 

* __Technische und Interaktionsdaten__: Firefox sendet Mozilla Daten, wie z. B. die Häufigkeit, mit der Firefox Inhalte vorschlägt oder anzeigt und Sie auf diese Inhalte klicken, sowie grundlegende Daten zu Ihren Interaktionen mit Firefox Suggest. Mozilla teilt zum Zweck des Nachweises und der Funktionsverbesserung mit unseren [Partnern](https://support.mozilla.org/kb/firefox-suggest#w_who-are-mozillas-partners) Informationen darüber, wie oft Empfehlungen angezeigt werden und wie häufig darauf geklickt wird. 

Wenn Sie die Funktion „Improve the Firefox Suggest Experience“ (Sucherlebnis von Firefox Suggest verbessern) aktivieren, gibt Firefox die nachstehend aufgeführten Informationen weiter, um Ihr Surferlebnis zu verbessern und den Dienst zu optimieren:

* __Suchen__: Firefox sendet Mozilla Ihre Eingaben in die Suchleiste. Mozilla ist berechtigt, diese Daten mit seinen [Partnern](https://support.mozilla.org/kb/firefox-suggest#w_who-are-mozillas-partners) zu teilen. 

Zur Beschränkung unserer Möglichkeiten wie auch der unserer Partner, Ihre Identität zu ermitteln, haben wir bestimmte Maßnahmen ergriffen. [Weitere Informationen](https://support.mozilla.org/kb/firefox-suggest?as=u&utm_source=inproduc).
...
* __Interaktionsdaten__: Wir erhalten Daten wie z. B. Ihre Besuche auf der Firefox-Konto-Website, Dashboards und Menüeinstellungen, die von Ihnen in Verbindung mit Ihrem Firefox-Konto verwendeten Produkte und Services und Ihre Interaktionen mit unseren E-Mail- und SMS-Nachrichten. Wir nutzen diese Informationen, um uns über Ihre Verwendung unserer Produkte und Services zu informieren und Ihnen nützlichere Firefox-Kontotipps und produktinterne Nachrichten zukommen zu lassen. Im [Glean Dictionary](https://dictionary.telemetry.mozilla.org/apps/accounts_frontend) können Sie mehr zu den von uns erfassten Interaktionsdaten erfahren.
...
* __Synchronisierte Daten__: Wenn Sie Sync aktivieren, erhält Mozilla Informationen, die Sie über verschiedene Geräte hinweg synchronisieren, in verschlüsselter Form. Dies kann Firefox-Tabs, Add-ons, Passwörter, Zahlungs-AutoFill-Informationen, Lesezeichen, Chronik und Einstellungen umfassen. Wenn Sie ihr Firefox-Konto löschen, werden auch die damit verbundenen Firefox Sync-Inhalte gelöscht. Weitere Informationen finden Sie in der [Dokumentation](https://moz-services-docs.readthedocs.io/en/latest/sync/).
