...
In den Vereinigten Staaten von Amerika ruft Firefox bereits bei Eingabe Ihrer Suchanfrage Vorschläge von den Servern von Mozilla ab. Wir nutzen eine datenschutzgerechte Technologie namens [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/), die Verschlüsselung und einen Proxy-Server kombiniert, um Ihre IP-Adresse und weitere Identifikationsdaten zu verbergen. Ihre Echtzeitsuchanfrage sowie technische Daten, Interaktionsdaten und aus der IP-Adresse abgeleitete Standortdaten werden standardmäßig über diesen OHTTP-Proxy weitergeleitet, bevor sie an Mozilla übertragen werden. Hierdurch wird verhindert, dass Dritte (einschließlich Mozilla) Ihre konkrete Suchanfrage mit Ihnen in Verbindung bringen oder mit anderen Informationen über Ihre Browsing-Aktivitäten verknüpfen können. Mozilla verarbeitet diese Daten, um Ihnen relevante Vorschläge zu unterbreiten, deren Nützlichkeit für Sie nachzuvollziehen und den Dienst zu verbessern. Unter bestimmten Umständen erhalten die Partnerunternehmen von Mozilla anonymisierte Such- und Interaktionsdaten, um relevante Vorschläge zu unterbreiten und die Interaktion der Benutzer mit vorgeschlagenen Inhalten zu messen.

Einige Benutzer – insbesondere solche in bestimmten Regionen außerhalb der USA sowie Benutzer in den USA, die in ihren Einstellungen die Option „Abrufen von Vorschlägen von Mozilla beim Eintippen“ deaktiviert haben – erhalten bei Verwendung der Funktion „Vorschläge von Firefox“ stattdessen lokal verarbeitete Ergebnisse. Für diese Benutzer werden die Vorschläge lokal unter Verwendung von in Ihrer Firefox-Version auf Ihrem Gerät gespeicherten Informationen bereitgestellt. Ihre anonymisierten Klick- und Interaktionsdaten für bestimmte Suchbegriffe (jedoch nicht Ihre Suchanfrage selbst) werden über OHTTP an Mozilla übermittelt, um Ihre IP-Adresse und weitere Identifikationsdaten zu verbergen. Bei gesponserten Vorschlägen erhalten unsere Partnerunternehmen möglicherweise aggregierte Informationen darüber, welche ihrer Vorschläge angezeigt und angeklickt wurden, jedoch nicht, welche Benutzer die Vorschläge gesehen haben oder welche Suchbegriffe zur Anzeige dieser Vorschläge geführt haben. (Sollten in Ihrer Region Vorschläge von Firefox nicht verfügbar sein, erhalten Sie lediglich Suchvorschläge.)

### Zur Bereitstellung relevanter Inhalte und Werbung auf einem neuen Firefox-Tab

Firefox zeigt auf der Seite „Neuer Tab“ Inhalte sowie Werbung an, um seine Weiterentwicklung zu unterstützen. Sie können diese Vorschläge in Ihren Browser-Einstellungen jederzeit deaktivieren.

Wir verwenden technische Daten, die bevorzugte Sprache und aus der IP-Adresse abgeleitete Standortdaten, um diese Inhalte im richtigen Format (d. h. für Mobilgeräte bzw. Desktop), in der entsprechenden Sprache und passend zum Standort bereitzustellen. Mozilla erfasst technische Daten und Interaktionsdaten, wie z. B. Position, Größe, Aufrufe und Klicks auf Inhalte oder Anzeigen auf der Seite „Neuer Tab“, um nachzuvollziehen, wie Nutzer mit unseren Inhalten interagieren, und künftige Inhalte, einschließlich gesponserter Inhalte, personalisieren zu können. Diese Daten können in aggregierter oder anonymisierter Form an unsere Werbepartner weitergegeben werden.

In einigen Regionen nutzen wir diese Daten, um Modelle zu konstruieren und Benutzer anhand allgemeiner Attribute zu Gruppen zusammenzufassen. Solche Gruppierungen erleichtern es uns, die Interaktion der Benutzer mit unseren Inhalten nachzuvollziehen und künftige Inhalte, einschließlich gesponserter Inhalte, zu personalisieren. Wir nutzen die Datenverarbeitung auf dem Gerät sowie OHTTP, um zu vermeiden, dass Attribute bestimmter Benutzer Mozilla gegenüber offengelegt werden. [Weitere Informationen](https://support.mozilla.org/kb/firefox-new-tab-personalization).

Ferner arbeiten wir mit Werbeanbietern zusammen, um mithilfe programmgesteuerter Technologien relevante gesponserte Inhalte bereitzustellen. Wir sind berechtigt, zu diesem Zweck begrenzte, nicht personenbezogene Daten – wie Gerätetyp, aus der IP-Adresse abgeleitete Standortdaten und die Kategorie der betrachteten Inhalte – weiterzugeben, um die Auswahl der anzuzeigenden Anzeigen zu bestimmen. Wir geben keine Informationen weiter, die Rückschlüsse auf Ihre Identität zulassen. Sie können gesponserte Inhalte jederzeit in den Einstellungen für die Seite „Neuer Tab“ deaktivieren.

In einigen Fällen können, wenn Anzeigen auf „Neuer Tab“ aktiviert sind, auch zusätzliche Browser-Daten sowie Interaktionsdaten (einschließlich Interaktionen mit unseren Werbetreibenden) lokal auf Ihrem Gerät verarbeitet werden, um die Wirksamkeit dieser Anzeigen zu messen; zudem nutzt die [Verknüpfungsfunktion](https://support.mozilla.org/kb/about-new-tab-page#w_shortcuts) lokal auf Ihrem Gerät gespeicherte Browser-Daten, um die beliebtesten Verknüpfungen auszuwählen, die zum Teil gesponsert sein können. Alle derartigen Daten werden unter Verwendung unserer datenschutzgerechten Technologien auf aggregierter und/oder anonymisierter Basis ausschließlich an Mozilla und/oder unsere Werbepartner weitergegeben.
...
Sie können jede dieser Funktionen für die Seite „Neue Tabs“ sowie die damit verbundene Datenverarbeitung in Ihren Browser-Einstellungen deaktivieren oder anpassen ([Desktop](https://support.mozilla.org/kb/customize-your-new-tab-page), [Android](https://support.mozilla.org/kb/customize-firefox-home-screen), [iOS](https://support.mozilla.org/kb/customize-firefox-home-ios)). Zudem können Sie [gesponserte Inhalte deaktivieren](https://support.mozilla.org/kb/sponsor-privacy), während Sie die übrigen Funktionen weiternutzen.
...
Sie haben die Möglichkeit, den KI-Chatbot eines Drittanbieters Ihrer Wahl zu nutzen, der Ihnen beispielsweise dabei hilft, das Gelesene zusammenzufassen oder Ideen zu notieren und zu sammeln. Diese Nutzung erfolgt im Einklang mit den [Nutzungsbedingungen und Datenschutzhinweis](https://support.mozilla.org/kb/ai-chatbot#w_learn-about-chatbot-providers) des betreffenden Anbieters.
...
Zusätzlich zu diesen Standardprozessen nutzen wir den [Safe Browsing-Service von Google](https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work), um Sie vor schädlichen Downloads und Phishing-Angriffen zu schützen, und validieren Webseiten- und technische Daten bei [Zertifizierungsstellen](https://support.mozilla.org/kb/secure-website-certificate). Im Rahmen unserer Bemühungen, den Datenschutz und die Sicherheit für alle Internetnutzer zu verbessern, erfassen wir technische Daten über OHTTP, um Fingerprinting besser verstehen, verhindern und uns davor schützen zu können.
...
*Weitere Informationen, einschließlich der Anpassung Ihrer Dateneinstellungen:* [Upgrades und Add-on-Blockierliste](https://support.mozilla.org/kb/how-stop-firefox-making-automatic-connections), [Safe Browsing-Service von Google](https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work), [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/),
...
*Weitere Informationen, einschließlich der Anpassung Ihrer Dateneinstellungen:* Sie können Ihre Datenerfassungseinstellungen für [Desktop](https://support.mozilla.org/kb/share-data-mozilla-help-improve-firefox) und [Mobilgeräte](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy) jederzeit ändern. Beachten Sie, dass das Deaktivieren der Option „Firefox erlauben, Daten zu technischen Details und Interaktionen an Mozilla zu senden“ keine Auswirkungen auf den [Ping zur täglichen Nutzung](https://support.mozilla.org/kb/usage-ping-settings) hat. Der Ping zur täglichen Nutzung liefert uns ausschließlich anonymisierte Informationen darüber, dass ein Benutzer Firefox verwendet. Er ist nicht mit anderen Daten zu Ihrer Person verknüpft, und Sie können ihn in den Einstellungen deaktivieren.

### Zur Vermarktung unserer Dienstleistungen

Wenn Sie uns dies gestatten, sendet Firefox Mozilla Daten über die Website-Domain oder eine bestimmte Werbekampagne (falls vorhanden), die Sie auf unsere Download-Seite verwiesen hat. Dies hilft uns, die Wirksamkeit unserer Marketingmaßnahmen zu verstehen und zu verbessern. Firefox gibt auch Informationen an unsere Marketingpartner weiter, um diese Kampagnen zu messen und zu verbessern. Welche Informationen im Einzelnen weitergegeben werden, richtet sich danach, wie Sie Firefox entdeckt haben und welches Betriebssystem Sie verwenden; in der Regel wird jedoch erfasst, wie Sie auf unsere Download-Seite gelangt sind und ob Sie Firefox aktiv nutzen. Wenn und soweit Firefox auf Ihrem Gerät vorinstalliert ist, werden technische Daten und Interaktionsdaten (Ihr Gerätetyp und ob Firefox verwendet wird) an unsere Marketingpartner gesendet und mit Mozilla geteilt.

*Weitere Informationen, einschließlich der Anpassung Ihrer Dateneinstellungen:* Erfahren Sie mehr darüber, welche [Kampagnenmessdaten](https://support.mozilla.org/kb/desktop-attribution-privacy) erfasst und offengelegt werden und welche Opt-out-Möglichkeiten Sie haben. Firefox gibt keine Informationen wie Ihre Browser-Chronik, Ihre Suchanfragen oder gespeicherte Passwörter an Marketingtechnologiepartner weiter. Mozilla erfasst lediglich die Daten, die zur Messung und Verbesserung unserer Marketingkampagnen erforderlich sind.

### Zur Pseudonymisierung, Anonymisierung oder Aggregierung von Daten

Im Rahmen der oben beschriebenen Aktivitäten, wie z. B. der Analyse der Firefox-Nutzung und der Messung unserer Marketingaktivitäten, sind wir berechtigt, pseudonyme, entpersonalisierte, aggregierte oder anonymisierte Daten zu erstellen. Wir setzen Technologien ein, die den Umständen angemessen sind, darunter die Technologien zum Entfernen von Erkennungsmerkmalen, OHTTP und [DAP](https://divviup.org/about/). Auf diese Weise wird verhindert, dass Daten mit Ihrer Person in Verbindung gebracht werden können. In einigen Fällen behalten wir uns vor, aggregierte und anonymisierte Daten weiterzugeben oder zu veröffentlichen, um Forschungen zu erleichtern, oder im Rahmen der oben genannten rechtmäßigen Geschäftszwecke (z. B. Weitergabe aggregierter Daten an Werbepartner).

### Zur Kommunikation mit Ihnen

Abhängig von Ihren Einstellungen (und davon, ob Sie ein Mozilla-Konto haben oder nicht) sind wir berechtigt, mit Ihnen über produktinterne Mitteilungen zu kommunizieren, Ihnen Mitteilungen (einschließlich werbebezogener Mitteilungen) zu senden, Sie zur Teilnahme an Umfragen/Studien einzuladen oder auf Ihre Mitteilungen an den Kundensupport zu antworten. Sie können sich auch direkt an uns wenden, z. B. um [die fehlerhafte Darstellung einer Website in Firefox zu melden](https://support.mozilla.org/kb/report-breakage-due-blocking#w_what-information-does-mozilla-collect-from-your-report). Wenn Sie mit uns auf diese Weise kommunizieren, werden wir die von Ihnen angegebenen Informationen ausschließlich für den von Ihnen angegebenen Zweck verwenden. Wir verarbeiten auch Interaktionsdaten im Zusammenhang mit diesen Mitteilungen, um besser zu verstehen, wer unsere servicebezogenen Ankündigungen (beispielsweise zu neuen Funktionen, Updates oder Sicherheitswarnungen) erhalten hat.
...
Sie können Ihre Datenerfassungseinstellungen für [Desktop](https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings) und [Mobilgeräte](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy) jederzeit ändern.
...
| Eindeutige Kennungen | Hierbei handelt es sich um eindeutige Kennungen, die zu verschiedenen Zeitpunkten erstellt werden können, um Ihre Interaktionen mit dem Dienst zu verwalten. | Client_id, session_id, Cookie-Kennungen. |
...
| Interaktionsdaten | Hierbei handelt es sich um Daten darüber, wie Sie mit unseren Diensten interagieren, z. B. wie viele Tabs Sie geöffnet oder worauf Sie geklickt haben. | Klickzahlen, Impressionsdaten, Zuordnungsdaten, Anzahl der durchgeführten Suchanfragen, Verweildauer auf der Seite, Klicks auf Anzeigen und gesponserte Kacheln. |
| Browser-Daten | Hierbei handelt es sich um Informationen über Websites und URLs, die Sie besucht haben. Dazu können Kategorien von Browser-Daten (Reisen, Einkaufen, soziale Medien), Top-Level-Domains (beispiel.com) oder bestimmte besuchte Webseiten gehören. | Browser-Kategorie, Top-Level-Domains (TLDs), konkrete URLs. |
| Suchdaten | Dies sind Daten über die Suchkategorie, die Suchbegriffe oder die Suchanfrage der gesuchten Begriffe. | Suchkategorie (Essen, Reisen), Schlüsselwörter („Berlin“), Sucheingabe („aktuelles Wetter in Berlin“). |
| Inhalt | Wenn Sie uns diese Informationen zur Verfügung stellen, sind wir berechtigt, sie zu verarbeiten. Hierbei handelt es sich beispielsweise um hochgeladene Bilder oder Umfrageantworten. | Hochgeladenes Bild, Lesezeichen, Kommentare, Umfrageantworten. |
| Kontaktdaten | Wenn Sie uns diese Informationen zur Verfügung stellen, sind wir berechtigt, Daten darüber zu verarbeiten, wie wir Sie kontaktieren können. | E-Mail-Adresse, Telefonnummer. |
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Sie können sich auch näher über <a href="https://support.mozilla.org/kb/website-translation">Übersetzungen</a> und das <a href="https://support.mozilla.org/kb/pdf-alt-text">Hinzufügen von Alt-Texten zu Bildern in PDF-Dateien</a> informieren.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Sie können weitere Informationen zur <a href="https://support.mozilla.org/kb/customize-your-new-tab-page">Verwaltung Ihrer Seite „Neuer Tab“</a> einschließlich Ihrer <a href="https://support.mozilla.org/kb/sponsor-privacy">Dateneinstellungen</a> nachlesen. Sie können sich jederzeit von der Verarbeitung Ihrer Daten für Personalisierungs- oder Werbezwecke abmelden. Hierzu deaktivieren Sie die Personalisierung und/oder gesponserte Inhalte in den Einstellungen.</td>
        </tr>
        <tr>
