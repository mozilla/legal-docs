...
Sie können ausführlichere Informationen über die von uns erfassten Daten für [Desktop](https://dictionary.telemetry.mozilla.org/apps/firefox_desktop), [Android](https://dictionary.telemetry.mozilla.org/apps/fenix) oder [iOS](https://dictionary.telemetry.mozilla.org/apps/firefox_ios) nachlesen. Sie können Ihre Datenerfassungseinstellungen für [Desktop](https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings) und [Mobilgeräte](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy) jederzeit ändern.
...
Wenn Sie in Firefox eine Suche durchführen, werden Ihre Suchanfrage sowie Geräte- und Standortdaten von Ihrer Standardsuchmaschine (gemäß deren [geltenden Datenschutzhinweis](#privacy-policies-for-search-providers)) verarbeitet, um Ihre Suchergebnisse und Suchvorschläge bereitzustellen. Mozilla erhält in der Regel Tantiemen, wenn Sie eine der Standard- oder der optionalen Suchoptionen im Firefox-Webbrowser nutzen.
...
Sie können weitere Informationen zur [Verwaltung Ihrer Seite „Neuer Tab“](https://support.mozilla.org/kb/customize-your-new-tab-page) einschließlich Ihrer Dateneinstellungen für [Desktop](https://support.mozilla.org/kb/sponsor-privacy), [Android](https://support.mozilla.org/kb/customize-firefox-home-screen) oder [iOS](https://support.mozilla.org/kb/customize-firefox-home-ios) nachlesen. Sie können die Verarbeitung Ihrer Daten für Personalisierungs- oder Werbezwecke jederzeit deaktivieren. Hierzu deaktivieren Sie die Option „Daten“ auf dem [Desktop](https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings) und auf [Mobilgeräten](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy).
...
Sie können mehr darüber nachlesen, wie Sie KI-Chatbots in Firefox [verwalten](https://support.mozilla.org/kb/ai-chatbot) oder [entfernen](https://support.mozilla.org/kb/ai-chatbot#w_how-to-remove-the-ai-chatbot-shortcut-from-your-firefox-sidebar) können.
...
Sie können weitere Informationen zu den [Upgrades und zur Add-on-Blockliste](https://support.mozilla.org/kb/how-stop-firefox-making-automatic-connections), zum [Safe Browsing-Service von Google](https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work) und zu [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/) abrufen oder [technische und Interaktionsdaten](https://support.mozilla.org/kb/technical-and-interaction-data) deaktivieren. 
...
Sie können Ihre Datenerfassungseinstellungen für [Desktop](https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings) und [Mobilgeräte](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy) jederzeit ändern (beachten Sie dabei, dass das Deaktivieren von „Firefox erlauben, technische Daten und Interaktionsdaten an Mozilla zu senden“, keine Auswirkungen auf den [Ping zur täglichen Nutzung](https://support.mozilla.org/kb/usage-ping-settings) hat). Der Ping zur täglichen Nutzung liefert uns ausschließlich anonymisierte Informationen darüber, dass ein Benutzer Firefox verwendet, und ist nicht mit anderen Daten zu Ihrer Person verknüpft. Er kann in den Einstellungen deaktiviert werden.

### Zur Vermarktung unserer Dienstleistungen

Wenn Sie uns dies gestatten, sendet Firefox Mozilla Daten über die Website-Domain oder eine bestimmte Werbekampagne (falls vorhanden), die Sie auf unsere Download-Seite verwiesen hat. Dies hilft uns, die Wirksamkeit unserer Marketingmaßnahmen zu verstehen und zu verbessern. Firefox gibt auch Informationen an unsere Marketingpartner weiter, um diese Kampagnen zu messen und zu verbessern. Welche Informationen im Einzelnen weitergegeben werden, richtet sich danach, wie Sie Firefox entdeckt haben und welches Betriebssystem Sie verwenden; in der Regel wird jedoch erfasst, wie Sie auf unsere Download-Seite gelangt sind und ob Sie Firefox aktiv nutzen. Wenn Firefox auf Ihrem Gerät vorinstalliert ist, werden technische Daten und Interaktionsdaten (Ihr Gerätetyp und ob Firefox verwendet wird) an unsere Marketingpartner gesendet und mit Mozilla geteilt.
...
| Spracheinstellung | Ihre abgeleitete oder bevorzugte Sprache (sofern in den Einstellungen angegeben) für die Interaktion mit unseren Diensten. | Sprache.  |
...
| Interaktionsdaten | Hierbei handelt es sich um Daten darüber, wie Sie mit unseren Diensten interagieren, z. B. wie viele Registerkarten Sie geöffnet haben oder worauf Sie geklickt haben.  | Klickzahlen, Impressionsdaten, Zuordnungsdaten, Anzahl der durchgeführten Suchanfragen, Verweildauer auf der Seite, Klicks auf Anzeigen und gesponserte Kacheln.  |
| Browser-Daten | Hierbei handelt es sich um Informationen über Websites und URLs, die Sie besucht haben. Dazu können Kategorien von Browser-Daten (Reisen, Einkaufen, soziale Medien), Top-Level-Domains (beispiel.com) oder bestimmte besuchte Webseiten gehören.  | Browser-Kategorie, Top-Level-Domains (TLDs), bestimmte URLs.  |
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>Sie können weitere Informationen zur <a href="https://support.mozilla.org/kb/customize-your-new-tab-page">Verwaltung Ihrer Seite „Neuer Tab“</a> einschließlich Ihrer Dateneinstellungen für <a href="https://support.mozilla.org/kb/sponsor-privacy">Desktop</a>, <a href="https://support.mozilla.org/kb/customize-firefox-home-screen">Android</a> oder <a href="https://support.mozilla.org/kb/customize-firefox-home-ios">iOS</a> nachlesen. Sie können die Verarbeitung Ihrer Daten für Personalisierungs- oder Werbezwecke jederzeit deaktivieren. Hierzu deaktivieren Sie die Option „Daten“ auf dem <a href="https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings">Desktop</a> und auf <a href="https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy">Mobilgeräten</a>.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Sie können weitere Informationen zu den <a href="https://support.mozilla.org/kb/how-stop-firefox-making-automatic-connections">Upgrades und zur Add-on-Blockliste</a>, zum <a href="https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work">Safe Browsing-Service von Google</a> und zu <a href="https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/">OHTTP</a> abrufen oder <a href="https://support.mozilla.org/kb/technical-and-interaction-data">technische und Interaktionsdaten</a> deaktivieren.</td>
        </tr>
        <tr>
