...
3. #### Функции
    ...
    Функция скриншотов Firefox позволяет вам сохранить содержимое веб-страниц, а затем просмотреть их или отправить другим пользователям. Информация о том, как сообщить с помощью скриншотов о нарушении авторских прав или незаконном использовании торговых марок, приведена [здесь](https://www.mozilla.org/en-US/about/legal/report-infringement/). Чтобы сообщить о нарушении, отправьте нам ссылку на скриншот на адрес screenshots-report@mozilla.com.
