...
This feature can be disabled by following the instructions in [this article](https://support.mozilla.org/kb/thunderbird-makes-unrequested-connections#w_extension-blocklist-updating). Disabling the Blocklist feature is not recommended as it may result in using extensions known to be untrustworthy.
