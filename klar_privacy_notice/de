...
{: #events .inproduct-link }
	...
	Wir erhalten grundlegende Informationen über Ihr Gerät und Klar, wie z. B. die Version von Klar, die Sie installiert haben, Ihr Betriebssystem, die Zeitzone und das Gebietsschema Ihres Systems.
...
Weitere Informationen über [technische Daten und Interaktionsdaten](https://github.com/mozilla-mobile/focus/wiki/Event-Tracking-with-Mozilla's-Telemetry-Service) oder darüber, wie Sie per [Opt-in](https://support.mozilla.org/en-US/kb/send-anonymous-usage-data-firefox-mobile-devices) dieser Datenerfassung zustimmen.
