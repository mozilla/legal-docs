...
U kunt meer gedetailleerde informatie lezen over de informatie die we verzamelen voor [desktops](https://dictionary.telemetry.mozilla.org/apps/firefox_desktop), [Android](https://dictionary.telemetry.mozilla.org/apps/fenix) of [iOS](https://dictionary.telemetry.mozilla.org/apps/firefox_ios). U kunt uw instellingen voor gegevensverzameling voor [desktops](https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings) en [mobiele apparaten](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy) op elk gewenst moment wijzigen.
...
Wanneer u een zoekopdracht uitvoert in Firefox, worden uw zoekopdracht, apparaatgegevens en locatiegegevens verwerkt door uw standaard zoekmachine (op basis van hun [toepasselijke privacyverklaring](#privacy-policies-for-search-providers)) om u zoekresultaten en zoeksuggesties te bieden. Mozilla ontvangt over het algemeen royaltybetalingen wanneer u de standaard zoekopties of de optionele zoekopties gebruikt in de Firefox-webbrowser.
...
U kunt meer informatie lezen over [hoe u de pagina Nieuw tabblad kunt beheren](https://support.mozilla.org/kb/customize-your-new-tab-page), waaronder uw gegevensinstellingen voor [desktops](https://support.mozilla.org/kb/sponsor-privacy), [Android](https://support.mozilla.org/kb/customize-firefox-home-screen) of [iOS](https://support.mozilla.org/kb/customize-firefox-home-ios). U kunt zich op elk gewenst moment uitschrijven voor de verwerking van uw gegevens voor persoonlijke afstemming of reclamedoeleinden door de optie voor gegevens voor [desktops](https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings) en [mobiele apparaten](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy) uit te schakelen.
...
U kunt meer lezen over hoe u AI-chatbots kunt [beheren](https://support.mozilla.org/kb/ai-chatbot) of [verwijderen](https://support.mozilla.org/kb/ai-chatbot#w_how-to-remove-the-ai-chatbot-shortcut-from-your-firefox-sidebar) in Firefox.
...
#### Meer lezen, waaronder informatie over hoe u uw gegevensinstellingen kunt aanpassen
...
U kunt meer lezen over de [Blokkeringslijst voor add-ons en upgrades](https://support.mozilla.org/kb/how-stop-firefox-making-automatic-connections), [Safe Browsing Service van Google](https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work) en [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/) of [technische en interactiegegevens](https://support.mozilla.org/kb/technical-and-interaction-data) uitschakelen. 
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>U kunt meer informatie lezen over <a href="https://support.mozilla.org/kb/customize-your-new-tab-page">hoe u de pagina Nieuw tabblad kunt beheren</a>, waaronder uw gegevensinstellingen voor <a href="https://support.mozilla.org/kb/sponsor-privacy">desktops</a>, <a href="https://support.mozilla.org/kb/customize-firefox-home-screen">Android</a> of <a href="https://support.mozilla.org/kb/customize-firefox-home-ios">iOS</a>. U kunt zich op elk gewenst moment uitschrijven voor de verwerking van uw gegevens voor persoonlijke afstemming of reclamedoeleinden door de optie voor gegevens voor <a href="https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings">desktops</a> en <a href="https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy">mobiele apparaten</a> uit te schakelen.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>U kunt meer lezen over de <a href="https://support.mozilla.org/kb/how-stop-firefox-making-automatic-connections">Blokkeringslijst voor add-ons en upgrades</a>, <a href="https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work">Safe Browsing Service van Google</a> en <a href="https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/">OHTTP</a> of <a href="https://support.mozilla.org/kb/technical-and-interaction-data">technische en interactiegegevens</a> uitschakelen.</td>
        </tr>
        <tr>
