...
In de Verenigde Staten haalt Firefox suggesties op vanaf servers van Mozilla terwijl u uw zoekopdracht typt. We gebruiken technologie voor privacybehoud die [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/) wordt genoemd. Deze technologie combineert versleuteling en een proxyserver om uw IP-adres en andere identificerende informatie te verbergen. Uw realtime zoekopdracht wordt standaard samen met technische, interactie- en van IP afgeleide locatiegegevens doorgegeven naar deze OHTTP-proxy voordat deze informatie naar Mozilla wordt verzonden. Dit helpt voorkomen dat iemand (inclusief Mozilla) uw specifieke zoekopdracht aan u kan koppelen of kan combineren met niet-gerelateerde informatie over uw navigatieactiviteit. Mozilla verwerkt deze gegevens om relevante suggesties voor u te verzorgen, om te doorgronden hoe bruikbaar de suggesties voor u zijn en om de service te verbeteren. Onder enkele omstandigheden ontvangen partners van Mozilla gedeïdentificeerde zoek- en interactiegegevens om relevante suggesties te verzorgen en gebruikersbetrokkenheid bij voorgestelde content te meten.

Sommige gebruikers, waaronder gebruikers in enkele regio’s buiten de Verenigde Staten en in de Verenigde Staten die de optie Suggesties van Mozilla ophalen terwijl u typt uitschakelen in hun instellingen, ontvangen in plaats daarvan lokaal verwerkte resultaten wanneer de functie Suggesties van Firefox wordt gebruikt. Voor deze gebruikers worden de suggesties lokaal verzorgd via informatie die in uw exemplaar van Firefox is opgeslagen op uw apparaat. Uw gedeïdentificeerde klik- en interactiegegevens voor specifieke zoektermen (maar niet uw zoekopdracht) worden via OHTTP naar Mozilla verzonden om uw IP-adres en andere identificerende informatie te verbergen. Bij gesponsorde suggesties ontvangen onze partners mogelijk samengevoegde informatie over welke van hun suggesties worden weergegeven en op welke suggesties is geklikt. Ze ontvangen echter geen informatie over welk gebruikers de suggesties hebben bekeken of over welke trefwoorden tot het verzorgen van de suggestie hebben geleid. (Als suggesties van Firefox niet beschikbaar zijn in uw regio, ontvangt u alleen zoeksuggesties.

### Het verzorgen van relevante content en reclame op Firefox Nieuw tabblad

Firefox geeft nu content weer op Nieuw tabblad. Er wordt ook reclame weergegeven voor het ondersteunen van de ontwikkeling van Firefox. U kunt dit op elk gewenst moment uitschakelen in uw browserinstellingen.

We gebruiken technische gegevens, de taalvoorkeur en de van IP afgeleide locatie om deze content in de juiste indeling (zoals voor een mobiel apparaat of een desktop), de juiste taal en voor de relevante locatie te verzorgen. Mozilla verzamelt technische en interactiegegevens, zoals gegevens over de positie, grootte, weergaven en klikken op content of advertenties op Nieuw tabblad om te doorgronden hoe mensen onze content gebruiken en om toekomstige content, waaronder gesponsorde content, aan te passen. Deze gegevens kunnen op een gedeïdentificeerde en/of samengevoegde basis worden gedeeld met onze partners.

In enkele regio’s gebruiken we deze gegevens om modellen te bouwen en gebruikers te groeperen op basis van gemeenschappelijke kenmerken. Deze groeperingen helpen ons doorgronden wat de interactie is van mensen met onze content en om toekomstige content, waaronder gesponsorde content, persoonlijk af te stemmen. We gebruiken verwerking op het apparaat en OHTTP om te voorkomen dat kenmerken van welke specifieke gebruiker dan ook, bekend worden gemaakt aan Mozilla. [Meer informatie](https://support.mozilla.org/kb/firefox-new-tab-personalization).

We werken ook samen met advertentie-aanbieders om relevante gesponsorde content te verzorgen via programmatische technologieën. Voor het ondersteunen hiervan kunnen we beperkte, niet-identificerende informatie delen, zoals het apparaattype, van IP afgeleide locatie-informatie en de weergegeven categorie van content, om te helpen bepalen welke advertenties worden weergegeven. We delen geen informatie die u identificeert. U kunt gesponsorde content op elke gewenst moment uitschakelen in uw instellingen voor Nieuw tabblad.

In sommige gevallen, waarin advertenties zijn ingeschakeld op Nieuw tabblad, kunnen lokaal op uw apparaat ook aanvullende navigatiegegevens worden verwerkt om de doeltreffendheid van die advertenties te meten. De functie voor [snelkoppelingen](https://support.mozilla.org/kb/about-new-tab-page#w_shortcuts) gebruikt eveneens navigatiegegevens lokaal op uw apparaat om de belangrijkste snelkoppelingen te selecteren. Enkele van deze snelkoppelingen zijn mogelijk gesponsord. Dergelijke gegevens worden alleen gedeeld met Mozilla en/of onze reclamepartners via technologieën voor privacybehoud en op een samengevoegde of gedeïdentificeerde basis.
...
U kunt deze functies voor Nieuw tabblad ook, samen met de bijbehorende gegevensverwerking, uitschakelen of aanpassen. Dit doet u in uw browserinstellingen ([desktop](https://support.mozilla.org/kb/customize-your-new-tab-page), [Android](https://support.mozilla.org/kb/customize-firefox-home-screen), [iOS](https://support.mozilla.org/kb/customize-firefox-home-ios)). U kunt [gesponsorde content ook uitschakelen](https://support.mozilla.org/kb/sponsor-privacy) en de rest van de functies blijven gebruiken.
...
We moeten ook gegevens verwerken om Firefox operationeel te houden, voor het verbeteren van functies en prestaties en voor het identificeren, diagnosticeren en oplossen van problemen. Hiervoor gebruiken we technische gegevens, van IP afgeleide locatiegegevens, gegevens over instellingen, interactiegegevens en gegevens over systeemprestaties (zoals het aantal open tabbladen, het geheugengebruik of de uitkomst van geautomatiseerde processen, zoals updates). In de zeldzame situaties waarin deze informatie nodig is, omvat dit ook beperkte navigatiegegevens (zoals annotaties voor domeinen op het hoogste niveau voor het monitoren van laadprestaties van pagina's). Deze worden verzonden via OHTTP. Dit voorkomt dat Mozilla u of uw apparaat kan koppelen aan de gegevens die voor dit doel worden verzameld.
...
Naast deze standaardprocessen gebruiken we [Safe Browsing Service van Google](https://support.mozilla.org/kb/how-does-phishing-and-malware-protection-work) om u te beschermen tegen schadelijke downloads en phishingaanvallen, en om webpagina- en technische gegevens te valideren via [certificeringsinstanties](https://support.mozilla.org/kb/secure-website-certificate). Als onderdeel van ons werk om privacy en beveiliging te verbeteren voor alle internetgebruikers, verzamelen we gegevens via OHTTP voor een beter inzicht in, een betere preventie van en een betere verdediging tegen fingerprinting.
...
U kunt uw instellingen voor gegevensverzameling voor [desktops](https://support.mozilla.org/kb/manage-firefox-data-collection-privacy-settings) en [mobiele apparaten](https://support.mozilla.org/kb/mobile-manage-firefox-data-collection-and-privacy) op elk gewenst moment wijzigen.
...
## Toepasselijkheid (Firefox-versie)
...
| Interactiegegevens | Dit zijn gegevens over hoe u omgaat met onze services, zoals hoeveel tabbladen u open hebt of waarop u hebt geklikt. | Kliktellingen, impressiegegevens, attributiegegevens, hoeveel zoekopdrachten zijn uitgevoerd, tijd op pagina, klikken op advertenties en gesponsorde tegels. |
...
| Zoekgegevens | Dit zijn gegevens over de zoekcategorie, zoektrefwoorden of zoekquerytermen waarnaar wordt gezocht. | Zoekcategorieën(Voedsel, Reizen), trefwoorden ('Boston'), zoektermen ('huidige weer in Boston'). |
...
| Contactgegevens | Wanneer u deze aan ons verstrekt, kunnen we gegevens verwerken over hoe we contact met u kunnen opnemen. | E-mailadres, telefoonnummer. |
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>U kunt ook meer lezen over <a href="https://support.mozilla.org/kb/website-translation">vertaling</a> en het <a href="https://support.mozilla.org/kb/pdf-alt-text">toevoegen van alternatieve tekst aan afbeeldingen in PDF's</a>.</td>
        </tr>
        <tr>
