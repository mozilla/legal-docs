...
### Untuk menyediakan peramban Firefox kepada Anda
...
Di Amerika Serikat, Firefox mengambil saran dari server Mozilla saat Anda mengetik kueri. Kami menggunakan teknologi yang menjaga privasi bernama [OHTTP](https://blog.mozilla.org/en/products/firefox/partnership-ohttp-prio/), yang memadukan enkripsi dan server proksi untuk menyembunyikan alamat IP Anda dan informasi pengidentifikasi lainnya. Kueri pencarian real-time Anda, beserta data teknis, interaksi dan lokasi yang diambil dari alamat IP dilewatkan melalui proksi OHTTP ini secara default sebelum dikirim ke Mozilla. Ini membantu mencegah siapa pun (termasuk Mozilla) mengaitkan kueri spesifik dengan Anda, atau menggabungkannya dengan informasi yang tidak terkait tentang aktivitas penjelajahan Anda. Mozilla memproses data ini untuk menampilkan saran yang relevan, memahami seberapa bermanfaat saran tersebut bagi Anda, dan meningkatkan layanan ini. Dalam beberapa keadaan, mitra Mozilla akan menerima data pencarian dan interaksi tanpa identitas, untuk menampilkan saran yang relevan dan mengukur interaksi pengguna dengan konten yang disarankan.
...
Kami menggunakan data teknis, preferensi bahasa, dan lokasi yang diambil dari alamat IP untuk menampilkan konten ini dalam format yang benar (yaitu untuk perangkat seluler vs desktop), bahasa, dan lokasi yang relevan. Mozilla mengumpulkan data teknis dan interaksi, seperti posisi, ukuran, tayangan, dan klik pada konten atau iklan Tab Baru, untuk memahami cara orang berinteraksi dengan konten kami dan untuk mempersonalisasi konten selanjutnya, termasuk konten bersponsor. Data ini dapat dibagikan kepada mitra periklanan kami secara agregat dan/atau tanpa identitas.

Dalam beberapa wilayah, kami menggunakan data ini untuk membangun model dan pengguna grup berdasarkan atribut umum. Pengelompokan ini membantu kami memahami cara orang berinteraksi dengan konten kami dan untuk mempersonalisasi konten mendatang, termasuk konten bersponsor. Kami menggunakan pemrosesan di perangkat dan OHTTP agar tidak menampilkan atribut pengguna tertentu kepada Mozilla. [Pelajari selengkapnya](https://support.mozilla.org/kb/firefox-new-tab-personalization).

Kami juga bekerja sama dengan penyedia periklanan untuk menampilkan konten bersponsor yang relevan menggunakan teknologi terprogram. Untuk mendukung ini, kami dapat membagikan informasi terbatas tanpa identitas — seperti jenis perangkat, lokasi yang diambil dari alamat IP, dan kategori konten yang dilihat — untuk membantu menentukan iklan mana yang akan ditampilkan. Kami tidak membagikan informasi apa pun yang mengidentifikasi Anda. Anda bisa menonaktifkan konten bersponsor di pengaturan Tab Baru Anda kapan saja.

Dalam beberapa kasus, saat iklan diaktifkan di Tab Baru, data penjelajahan dan interaksi tambahan (termasuk interaksi dengan pengiklan kami) juga bisa diproses secara lokal di perangkat Anda untuk mengukur efektivitas iklan tersebut; fitur [pintasan](https://support.mozilla.org/kb/about-new-tab-page#w_shortcuts) juga menggunakan data penjelajahan secara lokal di perangkat Anda untuk memilih pintasan teratas, yang sebagian di antaranya mungkin bersponsor. Data seperti itu hanya akan dibagikan kepada Mozilla dan/atau mitra periklanan kami melalui teknologi kami yang menjaga privasi secara agregat dan/atau tanpa identitas.
...
Kami juga perlu memproses data untuk memastikan Firefox terus beroperasi, meningkatkan fitur dan kinerja, serta mengidentifikasi, memecahkan masalah, dan mendiagnosis masalah. Untuk ini, kami menggunakan data teknis, lokasi yang diambil dari alamat IP, dan pengaturan, serta data interaksi dan kinerja sistem (seperti jumlah tab yang terbuka, penggunaan memori, atau hasil proses otomatis seperti pembaruan). Dalam situasi yang jarang terjadi ketika informasi yang diperlukan juga mencakup data penjelajahan terbatas (misalnya, anotasi Domain Tingkat Atas untuk pemantauan kinerja pemuatan halaman), informasi tersebut akan dikirimkan menggunakan OHTTP; ini membantu mencegah Mozilla menghubungkan Anda atau perangkat Anda ke data yang dikumpulkan untuk tujuan ini.
...
<table>
    ...
    <tbody>
        <tr>
            <td><a id="bookmark-how-we-use-data"></a>Untuk menyediakan peramban Firefox kepada Anda</td>
            <td>
                <ul>
                    <li>Data teknis</li>
                    <li>Lokasi</li>
            ...
            <td>Anda juga dapat mempelajari lebih lanjut tentang <a href="https://support.mozilla.org/kb/website-translation">terjemahan</a> dan <a href="https://support.mozilla.org/kb/pdf-alt-text">menambahkan teks alternatif ke gambar di PDF</a>.</td>
        </tr>
        <tr>
        ...
        <tr>
            <td>Untuk menampilkan konten dan iklan yang relevan di Tab Baru Firefox</td>
            <td>
                <ul>
                    <li>Data teknis</li>
                    <li>Lokasi</li>
