...
Firefox; Duyurular (Mozilla’dan mesajlar), Eklenti Önerileri, Öne Çıkanlar (Mozilla’nın ilk kez Firefox kullananlar için önerdiği web siteleri) ve Pocket Tavsiyeleri (Mozilla ailesi kapsamında) gibi içerikleri gösterir.
...
* __Öne Çıkanlar için Konum ve Etkileşim Verileri__: Yeni Sekmesi’nde yer alan Amazon.com Öne Çıkan Site kutucuğunu tıkladığınızda, Amazon’a yönlendirilmenizi doğrulamak üzere Amazon ve AdMarketplace (üçüncü taraf bir yönlendirme platformu) ile ülkenizi ve tıklama tarihinizi paylaşıyoruz. Firefox, IP adresinizi veya kimliğinizi belirlemek için kullanılabilecek diğer hiçbir bilgiyi Amazon veya AdMarketplace ile paylaşmaz.
...
### Firefox Hesapları ve Firefox’a Katılın
...
[Belgenin tamamını](https://mozilla-push-service.readthedocs.io/en/latest/) okuyun ya da web sitesi bildirimlerini iptal etmenin yolları dahil olmak üzere [daha fazla bilgi alın](https://support.mozilla.org/kb/push-notifications-firefox).
