...
* **Отслеживание направлений и кампаний**{: #thirdparty } ** **{: #referraltracking }
	...
	С целью изучения и совершенствования наших маркетинговых кампаний Firefox может отправлять «данные направления», такие как домен веб-сайта или рекламная кампания, из которых вы были направлены на загрузку и установку Firefox.
