...
* __Webseitendaten für Pocket-Empfehlungen__: Wir empfehlen Ihnen Inhalte auf Grundlage Ihrer Browserchronik. Was Sie letztlich zu sehen bekommen wird lokal in Ihrer Firefox-Version entschieden. Weder Mozilla noch Pocket (gehört zur Mozilla-Familie) erhalten eine Kopie Ihrer Browserchronik. Was wir erhalten, sind aggregierte Daten zu den Empfehlungen, die Ihnen angezeigt werden und auf die Sie klicken. Weitere Informationen. Über diese Daten können Sie als Person nicht identifiziert werden. Aggregierte Daten zu gesponserten Inhalten, die Ihnen angezeigt und von Ihnen angeklickt wurden, geben wir auch an unsere Anzeigenplattform Adzerk (Drittanbieter) weiter. Dadurch können Werbetreibende erkennen, wie viele Menschen ihre Artikel aufgerufen haben; sie können aber nicht sehen, wer diese angeklickt und angezeigt hat.
