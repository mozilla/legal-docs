...
* **Προεπιλεγμένη αναζήτηση**
{: #thirdparty }

	Για να σας βοηθήσει να επιλέξετε την καλύτερη προεπιλεγμένη μηχανή αναζήτησης για την τοποθεσία σας, ο Firefox στέλνει στη Mozilla ένα εφάπαξ αίτημα να αναζητήσει την τοποθεσία σας, σε επίπεδο χώρας, με τη βοήθεια της διεύθυνσης IP σας. Στη συνέχεια επιστρέφουμε αυτή την πληροφορία επιπέδου χώρας στον Firefox, όπου αυτή φυλάσσεται τοπικά. Στη συνέχεια, ο Firefox επιλέγει ποια μηχανή αναζήτησης να χρησιμοποιήσει ως προεπιλογή, ανάλογα με τις τοπικά αποθηκευμένες πληροφορίες χώρας. Μπορείτε να [μάθετε περισσότερα εδώ](https://support.mozilla.org/kb/send-anonymous-usage-data-firefox-mobile-devices), συμπεριλαμβανομένου του τρόπου απενεργοποίησής της.
