...
* **Καταγραφή παραπομπών και καμπάνιας**{: #thirdparty } ** **{: #referraltracking }
	...
	Για να κατανοήσουμε καλύτερα και να βελτιώσουμε τις καμπάνιες μάρκετινγκ που διεξάγουμε, ο Firefox μπορεί να στέλνει “Δεδομένα Παραπομπών”, όπως το domain της ιστοσελίδας ή η διαφημιστική καμπάνια που σας παρέπεμψε να κάνετε λήψη και εγκατάσταση του Firefox.
 
	Στα Android και iOS, ο Firefox στέλνει Δεδομένα Παραπομπών στον προμηθευτή μας αναλυτικής για κινητά, ενώ περιλαμβάνει επίσης αναγνωριστικό διαφήμισης Google, διεύθυνση IP, χρονοσήμανση, χώρα, τοποθεσία, λειτουργικό σύστημα και έκδοση εφαρμογής. Μπορείτε να μάθετε περισσότερα [εδώ](https://support.mozilla.org/kb/send-anonymous-usage-data-firefox-mobile-devices), συμπεριλαμβανομένου του τρόπου απενεργοποίησης αυτών των αναφορών.
...
Με εξαίρεση τις περιπτώσεις στις οποίες σημειώνεται κάτι διαφορετικό, η παρούσα πολιτική απορρήτου αφορά τις πιο πρόσφατες εκδόσεις για γενική κυκλοφορία του Firefox. Οι προεκδόσεις μας (Beta, έκδοση Aurora/Developer, Nightly και TestFlight) βρίσκονται ακόμα σε φάση ενεργής ανάπτυξης και μπορεί να περιέχουν νέες δυνατότητες ή να έχουν διαφορετικά χαρακτηριστικά απορρήτου. Οι προεκδόσεις στέλνουν αυτόματα [Δεδομένα τηλεμετρίας](https://gecko.readthedocs.io/en/latest/toolkit/components/telemetry/telemetry/index.html) στην Mozilla, τα οποία μας βοηθούν να βελτιώσουμε το Firefox.
{: #pre-release }
