...
* **Препораки и следење кампањи**{: #thirdparty } ** **{: #referraltracking }
	...
	За подобро да ги разбереме и подобриме нашите рекламни кампањи, Firefox може да испраќа „Податоци за препораки“, како што се доменот на веб-локацијата или рекламната кампања од каде што сте добиле препораки за преземање и инсталирање на Firefox.
 
	На Android и iOS, Firefox испраќа „Податоци за препораки“ до својот давател на услуги за мобилна аналитика, а вклучува и ID за рекламирање од Google, IP-адреса, време, земја, поставки за локалниот јазик, оперативен систем и верзија на апликацијата. Дознајте повеќе [тука](https://support.mozilla.org/kb/send-anonymous-usage-data-firefox-mobile-devices), вклучително и како да го оневозможите извештајов.
