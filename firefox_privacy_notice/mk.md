...
* **Sync**: [Firefox Sync](https://www.mozilla.org/firefox/sync/) е услуга што ви овозможува да ги синхронизирате обележувачите, историјата на прелистување, лозинките и поставките на Firefox со сите ваши уреди. Ако ја користите услугата Sync, може да ја прочитате [Изјавата за приватност на Firefox Sync ](https://accounts.firefox.com/legal/privacy).
{: #sync }
