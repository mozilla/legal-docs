...
{: #thirdparty }
	...
	Mozilla が実施する特定のマーケティングキャンペーンの成果を把握するため、Firefox は、Google の広告 ID 、IP アドレス、タイムスタンプ、国、言語・ロケール、オペレーションシステム、アプリのバージョンを含むデータを第三者ベンダーへ送信します。Mozilla は、これらのデータにより、インストールされたアプリを特定の広告チャンネルと結び付けて、マーケティングキャンペーン戦略を最適化することができます。この機能を無効にする方法など、詳細については、[こちらの記事](https://support.mozilla.org/kb/send-anonymous-usage-data-firefox-mobile-devices)をご覧ください。
